(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerpolicy&&(t.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?t.credentials="include":s.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();function y(){}function _a(e,a){for(const o in a)e[o]=a[o];return e}function Ca(e){return e()}function la(){return Object.create(null)}function T(e){e.forEach(Ca)}function Ea(e){return typeof e=="function"}function R(e,a){return e!=e?a==a:e!==a||e&&typeof e=="object"||typeof e=="function"}let K;function ea(e,a){return K||(K=document.createElement("a")),K.href=a,e===K.href}function Fa(e){return Object.keys(e).length===0}function Va(e,a,o,r){if(e){const s=xa(e,a,o,r);return e[0](s)}}function xa(e,a,o,r){return e[1]&&r?_a(o.ctx.slice(),e[1](r(a))):o.ctx}function Pa(e,a,o,r){if(e[2]&&r){const s=e[2](r(o));if(a.dirty===void 0)return s;if(typeof s=="object"){const t=[],n=Math.max(a.dirty.length,s.length);for(let d=0;d<n;d+=1)t[d]=a.dirty[d]|s[d];return t}return a.dirty|s}return a.dirty}function La(e,a,o,r,s,t){if(s){const n=xa(a,o,r,t);e.p(n,s)}}function Da(e){if(e.ctx.length>32){const a=[],o=e.ctx.length/32;for(let r=0;r<o;r++)a[r]=-1;return a}return-1}function g(e,a){e.appendChild(a)}function x(e,a,o){e.insertBefore(a,o||null)}function V(e){e.parentNode&&e.parentNode.removeChild(e)}function W(e,a){for(let o=0;o<e.length;o+=1)e[o]&&e[o].d(a)}function q(e){return document.createElement(e)}function Ua(e){return document.createElementNS("http://www.w3.org/2000/svg",e)}function G(e){return document.createTextNode(e)}function P(){return G(" ")}function da(){return G("")}function F(e,a,o,r){return e.addEventListener(a,o,r),()=>e.removeEventListener(a,o,r)}function B(e){return function(a){return a.preventDefault(),e.call(this,a)}}function m(e,a,o){o==null?e.removeAttribute(a):e.getAttribute(a)!==o&&e.setAttribute(a,o)}function Na(e){return Array.from(e.childNodes)}function ia(e,a){a=""+a,e.wholeText!==a&&(e.data=a)}function I(e,a){e.value=a??""}function O(e,a,o){e.classList[o?"add":"remove"](a)}class Ia{constructor(a=!1){this.is_svg=!1,this.is_svg=a,this.e=this.n=null}c(a){this.h(a)}m(a,o,r=null){this.e||(this.is_svg?this.e=Ua(o.nodeName):this.e=q(o.nodeName),this.t=o,this.c(a)),this.i(r)}h(a){this.e.innerHTML=a,this.n=Array.from(this.e.childNodes)}i(a){for(let o=0;o<this.n.length;o+=1)x(this.t,this.n[o],a)}p(a){this.d(),this.h(a),this.i(this.a)}d(){this.n.forEach(V)}}let ua;function H(e){ua=e}const w=[],ra=[],Y=[],sa=[],ya=Promise.resolve();let ta=!1;function Ta(){ta||(ta=!0,ya.then(Ma))}function na(e){Y.push(e)}function Ra(e){sa.push(e)}const oa=new Set;let X=0;function Ma(){const e=ua;do{for(;X<w.length;){const a=w[X];X++,H(a),ka(a.$$)}for(H(null),w.length=0,X=0;ra.length;)ra.pop()();for(let a=0;a<Y.length;a+=1){const o=Y[a];oa.has(o)||(oa.add(o),o())}Y.length=0}while(w.length);for(;sa.length;)sa.pop()();ta=!1,oa.clear(),H(e)}function ka(e){if(e.fragment!==null){e.update(),T(e.before_update);const a=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,a),e.after_update.forEach(na)}}const aa=new Set;let $;function Qa(){$={r:0,c:[],p:$}}function $a(){$.r||T($.c),$=$.p}function L(e,a){e&&e.i&&(aa.delete(e),e.i(a))}function D(e,a,o,r){if(e&&e.o){if(aa.has(e))return;aa.add(e),$.c.push(()=>{aa.delete(e),r&&(o&&e.d(1),r())}),e.o(a)}else r&&r()}function Ba(e,a,o,r){const s=e.$$.props[a];s!==void 0&&(e.$$.bound[s]=o,r===void 0&&o(e.$$.ctx[s]))}function U(e){e&&e.c()}function J(e,a,o,r){const{fragment:s,after_update:t}=e.$$;s&&s.m(a,o),r||na(()=>{const n=e.$$.on_mount.map(Ca).filter(Ea);e.$$.on_destroy?e.$$.on_destroy.push(...n):T(n),e.$$.on_mount=[]}),t.forEach(na)}function _(e,a){const o=e.$$;o.fragment!==null&&(T(o.on_destroy),o.fragment&&o.fragment.d(a),o.on_destroy=o.fragment=null,o.ctx=[])}function Ga(e,a){e.$$.dirty[0]===-1&&(w.push(e),Ta(),e.$$.dirty.fill(0)),e.$$.dirty[a/31|0]|=1<<a%31}function k(e,a,o,r,s,t,n,d=[-1]){const p=ua;H(e);const i=e.$$={fragment:null,ctx:[],props:t,update:y,not_equal:s,bound:la(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(a.context||(p?p.$$.context:[])),callbacks:la(),dirty:d,skip_bound:!1,root:a.target||p.$$.root};n&&n(i.root);let b=!1;if(i.ctx=o?o(e,a.props||{},(h,E,...C)=>{const A=C.length?C[0]:E;return i.ctx&&s(i.ctx[h],i.ctx[h]=A)&&(!i.skip_bound&&i.bound[h]&&i.bound[h](A),b&&Ga(e,h)),E}):[],i.update(),b=!0,T(i.before_update),i.fragment=r?r(i.ctx):!1,a.target){if(a.hydrate){const h=Na(a.target);i.fragment&&i.fragment.l(h),h.forEach(V)}else i.fragment&&i.fragment.c();a.intro&&L(e.$$.fragment),J(e,a.target,a.anchor,a.customElement),Ma()}H(p)}class Q{$destroy(){_(this,1),this.$destroy=y}$on(a,o){if(!Ea(o))return y;const r=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);return r.push(o),()=>{const s=r.indexOf(o);s!==-1&&r.splice(s,1)}}$set(a){this.$$set&&!Fa(a)&&(this.$$.skip_bound=!0,this.$$set(a),this.$$.skip_bound=!1)}}function wa(e){let a;return{c(){a=G("Hello World")},m(o,r){x(o,a,r)},d(o){o&&V(a)}}}function Ha(e){let a,o,r,s;const t=e[1].default,n=Va(t,e,e[0],null),d=n||wa();return{c(){a=q("header"),o=q("div"),r=q("h1"),d&&d.c(),m(r,"class","header__title svelte-liwc8f"),m(o,"class","header__container svelte-liwc8f"),m(a,"class","header svelte-liwc8f")},m(p,i){x(p,a,i),g(a,o),g(o,r),d&&d.m(r,null),s=!0},p(p,[i]){n&&n.p&&(!s||i&1)&&La(n,t,p,p[0],s?Pa(t,p[0],i,null):Da(p[0]),null)},i(p){s||(L(d,p),s=!0)},o(p){D(d,p),s=!1},d(p){p&&V(a),d&&d.d(p)}}}function Wa(e,a,o){let{$$slots:r={},$$scope:s}=a;return e.$$set=t=>{"$$scope"in t&&o(0,s=t.$$scope)},[s,r]}class Ka extends Q{constructor(a){super(),k(this,a,Wa,Ha,R,{})}}function ga(e,a,o){const r=e.slice();return r[3]=a[o],r}function va(e){let a,o,r=e[3].label+"",s,t,n,d;function p(){return e[2](e[3])}return{c(){a=q("li"),o=q("a"),s=G(r),t=P(),m(o,"href","#"),m(o,"class","nav__link svelte-1n62zsf"),m(a,"class","nav__item svelte-1n62zsf"),O(a,"nav__item--active",e[3].slug==e[0])},m(i,b){x(i,a,b),g(a,o),g(o,s),g(a,t),n||(d=F(o,"click",B(p)),n=!0)},p(i,b){e=i,b&2&&r!==(r=e[3].label+"")&&ia(s,r),b&3&&O(a,"nav__item--active",e[3].slug==e[0])},d(i){i&&V(a),n=!1,d()}}}function Xa(e){let a,o,r=e[1],s=[];for(let t=0;t<r.length;t+=1)s[t]=va(ga(e,r,t));return{c(){a=q("nav"),o=q("ul");for(let t=0;t<s.length;t+=1)s[t].c();m(o,"class","nav__list svelte-1n62zsf"),m(a,"class","nav svelte-1n62zsf")},m(t,n){x(t,a,n),g(a,o);for(let d=0;d<s.length;d+=1)s[d].m(o,null)},p(t,[n]){if(n&3){r=t[1];let d;for(d=0;d<r.length;d+=1){const p=ga(t,r,d);s[d]?s[d].p(p,n):(s[d]=va(p),s[d].c(),s[d].m(o,null))}for(;d<s.length;d+=1)s[d].d(1);s.length=r.length}},i:y,o:y,d(t){t&&V(a),W(s,t)}}}function Za(e,a,o){let{value:r}=a,{items:s}=a;const t=n=>o(0,r=n.slug);return e.$$set=n=>{"value"in n&&o(0,r=n.value),"items"in n&&o(1,s=n.items)},[r,s,t]}class Ya extends Q{constructor(a){super(),k(this,a,Za,Xa,R,{value:0,items:1})}}function ae(e){let a,o,r;const s=e[2].default,t=Va(s,e,e[1],null);return{c(){a=q("ul"),t&&t.c(),m(a,"class",o="list "+e[0]+" svelte-t0otg3")},m(n,d){x(n,a,d),t&&t.m(a,null),r=!0},p(n,[d]){t&&t.p&&(!r||d&2)&&La(t,s,n,n[1],r?Pa(s,n[1],d,null):Da(n[1]),null),(!r||d&1&&o!==(o="list "+n[0]+" svelte-t0otg3"))&&m(a,"class",o)},i(n){r||(L(t,n),r=!0)},o(n){D(t,n),r=!1},d(n){n&&V(a),t&&t.d(n)}}}function ee(e,a,o){let{$$slots:r={},$$scope:s}=a,{className:t=""}=a;return e.$$set=n=>{"className"in n&&o(0,t=n.className),"$$scope"in n&&o(1,s=n.$$scope)},[t,s,r]}class Oa extends Q{constructor(a){super(),k(this,a,ee,ae,R,{className:0})}}const oe="/dnd/assets/x-25909307.svg";function fa(e,a,o){const r=e.slice();return r[2]=a[o],r}function qa(e){let a,o=e[0][e[2]]+"",r;return{c(){a=new Ia(!1),r=da(),a.a=r},m(s,t){a.m(o,s,t),x(s,r,t)},p(s,t){t&1&&o!==(o=s[0][s[2]]+"")&&a.p(o)},d(s){s&&V(r),s&&a.d()}}}function re(e){let a,o,r,s,t,n,d,p,i,b=e[0].name+"",h,E,C,A,v=Object.keys(e[0]),l=[];for(let c=0;c<v.length;c+=1)l[c]=qa(fa(e,v,c));return{c(){a=q("div"),o=q("div"),r=P(),s=q("div"),t=q("button"),n=q("img"),p=P(),i=q("h2"),h=G(b),E=P();for(let c=0;c<l.length;c+=1)l[c].c();m(o,"class","overlay svelte-1wu5zh3"),ea(n.src,d=oe)||m(n,"src",d),m(n,"alt","close"),m(t,"class","close svelte-1wu5zh3"),m(i,"class","title svelte-1wu5zh3"),m(s,"class","container svelte-1wu5zh3"),m(a,"class","modal svelte-1wu5zh3"),O(a,"active",e[0].isActive)},m(c,j){x(c,a,j),g(a,o),g(a,r),g(a,s),g(s,t),g(t,n),g(s,p),g(s,i),g(i,h),g(s,E);for(let u=0;u<l.length;u+=1)l[u].m(s,null);C||(A=[F(o,"click",B(e[1])),F(t,"click",B(e[1]))],C=!0)},p(c,[j]){if(j&1&&b!==(b=c[0].name+"")&&ia(h,b),j&1){v=Object.keys(c[0]);let u;for(u=0;u<v.length;u+=1){const z=fa(c,v,u);l[u]?l[u].p(z,j):(l[u]=qa(z),l[u].c(),l[u].m(s,null))}for(;u<l.length;u+=1)l[u].d(1);l.length=v.length}j&1&&O(a,"active",c[0].isActive)},i:y,o:y,d(c){c&&V(a),W(l,c),C=!1,T(A)}}}function se(e,a,o){let{entry:r}=a;function s(){o(0,r.isActive=!1,r)}return e.$$set=t=>{"entry"in t&&o(0,r=t.entry)},[r,s]}class te extends Q{constructor(a){super(),k(this,a,se,re,R,{entry:0})}}const ne="/dnd/assets/search-3252ceb1.svg";function ha(e,a,o){const r=e.slice();return r[6]=a[o],r}function ba(e,a,o){const r=e.slice();return r[6]=a[o],r[9]=a,r[10]=o,r}function Aa(e){let a,o,r,s=e[6].name+"",t,n,d;function p(){return e[5](e[6],e[9],e[10])}return{c(){a=q("li"),o=q("a"),r=q("span"),t=G(s),m(r,"class","init__text"),m(o,"href","#"),m(o,"class","init__content svelte-12ax5ri"),m(a,"class","init__item svelte-12ax5ri")},m(i,b){x(i,a,b),g(a,o),g(o,r),g(r,t),n||(d=F(o,"click",B(p)),n=!0)},p(i,b){e=i,b&4&&s!==(s=e[6].name+"")&&ia(t,s)},d(i){i&&V(a),n=!1,d()}}}function ja(e){let a,o;return a=new te({props:{entry:e[6]}}),{c(){U(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,s){const t={};s&4&&(t.entry=r[6]),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){D(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}function de(e){let a,o,r,s,t,n,d,p,i,b,h,E,C,A=e[2],v=[];for(let u=0;u<A.length;u+=1)v[u]=Aa(ba(e,A,u));let l=e[2],c=[];for(let u=0;u<l.length;u+=1)c[u]=ja(ha(e,l,u));const j=u=>D(c[u],1,1,()=>{c[u]=null});return{c(){a=q("li"),o=q("form"),r=q("input"),s=P(),t=q("button"),n=q("img"),p=P();for(let u=0;u<v.length;u+=1)v[u].c();i=P();for(let u=0;u<c.length;u+=1)c[u].c();b=da(),m(r,"type","search"),m(r,"class","input svelte-12ax5ri"),m(r,"placeholder",e[0]),ea(n.src,d=ne)||m(n,"src",d),m(n,"alt","add user"),m(n,"class","svelte-12ax5ri"),m(t,"class","button button--icon svelte-12ax5ri"),t.disabled=!0,m(o,"class","init__form svelte-12ax5ri"),m(a,"class","init__item svelte-12ax5ri")},m(u,z){x(u,a,z),g(a,o),g(o,r),I(r,e[1]),g(o,s),g(o,t),g(t,n),x(u,p,z);for(let f=0;f<v.length;f+=1)v[f].m(u,z);x(u,i,z);for(let f=0;f<c.length;f+=1)c[f].m(u,z);x(u,b,z),h=!0,E||(C=[F(r,"input",e[4]),F(o,"submit",B(ue))],E=!0)},p(u,z){if((!h||z&1)&&m(r,"placeholder",u[0]),z&2&&I(r,u[1]),z&4){A=u[2];let f;for(f=0;f<A.length;f+=1){const M=ba(u,A,f);v[f]?v[f].p(M,z):(v[f]=Aa(M),v[f].c(),v[f].m(i.parentNode,i))}for(;f<v.length;f+=1)v[f].d(1);v.length=A.length}if(z&4){l=u[2];let f;for(f=0;f<l.length;f+=1){const M=ha(u,l,f);c[f]?(c[f].p(M,z),L(c[f],1)):(c[f]=ja(M),c[f].c(),L(c[f],1),c[f].m(b.parentNode,b))}for(Qa(),f=l.length;f<c.length;f+=1)j(f);$a()}},i(u){if(!h){for(let z=0;z<l.length;z+=1)L(c[z]);h=!0}},o(u){c=c.filter(Boolean);for(let z=0;z<c.length;z+=1)D(c[z]);h=!1},d(u){u&&V(a),u&&V(p),W(v,u),u&&V(i),W(c,u),u&&V(b),E=!1,T(C)}}}function ie(e){let a,o;return a=new Oa({props:{className:"db",$$slots:{default:[de]},$$scope:{ctx:e}}}),{c(){U(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,[s]){const t={};s&2055&&(t.$$scope={dirty:s,ctx:r}),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){D(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}const ue=()=>{};function me(e,a,o){let r,{data:s}=a,{label:t}=a,n="";function d(){n=this.value,o(1,n)}const p=(i,b,h)=>o(2,b[h].isActive=!0,r);return e.$$set=i=>{"data"in i&&o(3,s=i.data),"label"in i&&o(0,t=i.label)},e.$$.update=()=>{e.$$.dirty&10&&o(2,r=Object.keys(s.entries).map(i=>({...s.entries[i],isModalOpen:!1})).filter(i=>i.name.toLowerCase().includes(n.toLowerCase())))},[t,n,r,s,d,p]}class Z extends Q{constructor(a){super(),k(this,a,me,ie,R,{data:3,label:0})}}const ce="/dnd/assets/user-plus-3c6aeeff.svg",pe="/dnd/assets/user-minus-e4725f11.svg";function za(e,a,o){const r=e.slice();return r[11]=a[o],r[12]=a,r[13]=o,r}function Sa(e){let a,o,r,s,t,n,d,p,i,b,h,E;function C(){e[7].call(r,e[12],e[13])}function A(){e[8].call(t,e[12],e[13])}function v(){return e[9](e[13])}return{c(){a=q("li"),o=q("form"),r=q("input"),s=P(),t=q("input"),n=P(),d=q("button"),p=q("img"),b=P(),m(r,"type","text"),m(r,"class","input input--clear svelte-1pkgwrc"),m(r,"placeholder","Personagem"),m(t,"type","text"),m(t,"class","input input--clear input--dice svelte-1pkgwrc"),m(t,"placeholder","1d20"),ea(p.src,i=pe)||m(p,"src",i),m(p,"alt","remove user"),m(p,"class","svelte-1pkgwrc"),m(d,"class","button button--icon button--secondary svelte-1pkgwrc"),m(d,"type","button"),m(o,"class","init__form svelte-1pkgwrc"),m(a,"class","init__item svelte-1pkgwrc")},m(l,c){x(l,a,c),g(a,o),g(o,r),I(r,e[11].name),g(o,s),g(o,t),I(t,e[11].dice),g(o,n),g(o,d),g(d,p),g(a,b),h||(E=[F(r,"input",C),F(t,"input",A),F(d,"click",v),F(o,"submit",B(ve))],h=!0)},p(l,c){e=l,c&4&&r.value!==e[11].name&&I(r,e[11].name),c&4&&t.value!==e[11].dice&&I(t,e[11].dice)},d(l){l&&V(a),h=!1,T(E)}}}function le(e){let a,o,r,s,t,n,d,p,i,b,h,E,C,A=e[2],v=[];for(let l=0;l<A.length;l+=1)v[l]=Sa(za(e,A,l));return{c(){a=q("li"),o=q("form"),r=q("input"),s=P(),t=q("input"),n=P(),d=q("button"),p=q("img"),b=P();for(let l=0;l<v.length;l+=1)v[l].c();h=da(),m(r,"type","text"),m(r,"class","input svelte-1pkgwrc"),m(r,"placeholder","Personagem"),m(t,"type","text"),m(t,"class","input input--dice svelte-1pkgwrc"),m(t,"placeholder","1d20"),ea(p.src,i=ce)||m(p,"src",i),m(p,"alt","add user"),m(p,"class","svelte-1pkgwrc"),m(d,"class","button button--icon svelte-1pkgwrc"),m(o,"class","init__form svelte-1pkgwrc"),m(a,"class","init__item svelte-1pkgwrc")},m(l,c){x(l,a,c),g(a,o),g(o,r),I(r,e[0]),g(o,s),g(o,t),I(t,e[1]),g(o,n),g(o,d),g(d,p),x(l,b,c);for(let j=0;j<v.length;j+=1)v[j].m(l,c);x(l,h,c),E||(C=[F(r,"input",e[5]),F(t,"input",e[6]),F(o,"submit",B(e[3]))],E=!0)},p(l,c){if(c&1&&r.value!==l[0]&&I(r,l[0]),c&2&&t.value!==l[1]&&I(t,l[1]),c&20){A=l[2];let j;for(j=0;j<A.length;j+=1){const u=za(l,A,j);v[j]?v[j].p(u,c):(v[j]=Sa(u),v[j].c(),v[j].m(h.parentNode,h))}for(;j<v.length;j+=1)v[j].d(1);v.length=A.length}},d(l){l&&V(a),l&&V(b),W(v,l),l&&V(h),E=!1,T(C)}}}function ge(e){let a,o;return a=new Oa({props:{className:"init",$$slots:{default:[le]},$$scope:{ctx:e}}}),{c(){U(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,[s]){const t={};s&16391&&(t.$$scope={dirty:s,ctx:r}),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){D(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}const ve=()=>{};function fe(e,a,o){let r="",s="",t=[];function n(){s===""&&o(1,s="1d20"),o(2,t=[{name:r,dice:s},...t]),o(0,r=""),o(1,s="")}function d(C){o(2,t=t.map((A,v)=>({...A,i:v})).filter(({i:A})=>A!==C))}function p(){r=this.value,o(0,r)}function i(){s=this.value,o(1,s)}function b(C,A){C[A].name=this.value,o(2,t)}function h(C,A){C[A].dice=this.value,o(2,t)}return[r,s,t,n,d,p,i,b,h,C=>d(C)]}class qe extends Q{constructor(a){super(),k(this,a,fe,ge,R,{})}}function he(e){let a,o;return a=new qe({}),{c(){U(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p:y,i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){D(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}function be(e){return[]}class Ae extends Q{constructor(a){super(),k(this,a,be,he,R,{})}}const je="Classes (SRD)",ze={Sorcerer:{description:`<p>Ao criar um aventureiro feiticeiro, você recebe as seguintes características de classe.</p>
...
<p>O cravo ou cravo-da-índia (Syzygium aromaticum), é uma árvore perene da família da murta, eles são secos e possuem botão fechado.</p>`,source:"LdJ pg. 157",name:"Cravo"}},_e={source:"data.source",weight:{path:"data.weight",converter:"weight"}},Fe={label:Oe,entries:Je,mapping:_e};function Ue(e){let a;return{c(){a=G("Iniciativa")},m(o,r){x(o,a,r)},d(o){o&&V(a)}}}function Ne(e){let a,o,r,s,t,n,d,p,i,b,h,E,C,A,v,l,c,j,u,z,f,M;o=new Ka({props:{$$slots:{default:[Ue]},$$scope:{ctx:e}}});function Ja(S){e[2](S)}let ma={items:e[1]};return e[0]!==void 0&&(ma.value=e[0]),s=new Ya({props:ma}),ra.push(()=>Ba(s,"value",Ja,e[0])),i=new Ae({}),E=new Z({props:{data:Se,label:"Classes"}}),v=new Z({props:{data:xe,label:"Raças"}}),j=new Z({props:{data:Me,label:"Magias"}}),f=new Z({props:{data:Fe,label:"Comércio"}}),{c(){a=q("div"),U(o.$$.fragment),r=P(),U(s.$$.fragment),n=P(),d=q("div"),p=q("div"),U(i.$$.fragment),b=P(),h=q("div"),U(E.$$.fragment),C=P(),A=q("div"),U(v.$$.fragment),l=P(),c=q("div"),U(j.$$.fragment),u=P(),z=q("div"),U(f.$$.fragment),m(p,"class","item svelte-18gp8wx"),O(p,"active",e[0]==="/iniciativa"),m(h,"class","item svelte-18gp8wx"),O(h,"active",e[0]==="/classes"),m(A,"class","item svelte-18gp8wx"),O(A,"active",e[0]==="/racas"),m(c,"class","item svelte-18gp8wx"),O(c,"active",e[0]==="/magias"),m(z,"class","item svelte-18gp8wx"),O(z,"active",e[0]==="/tradegoods"),m(d,"class","content svelte-18gp8wx"),m(a,"class","page svelte-18gp8wx")},m(S,N){x(S,a,N),J(o,a,null),g(a,r),J(s,a,null),g(a,n),g(a,d),g(d,p),J(i,p,null),g(d,b),g(d,h),J(E,h,null),g(d,C),g(d,A),J(v,A,null),g(d,l),g(d,c),J(j,c,null),g(d,u),g(d,z),J(f,z,null),M=!0},p(S,[N]){const ca={};N&8&&(ca.$$scope={dirty:N,ctx:S}),o.$set(ca);const pa={};!t&&N&1&&(t=!0,pa.value=S[0],Ra(()=>t=!1)),s.$set(pa),(!M||N&1)&&O(p,"active",S[0]==="/iniciativa"),(!M||N&1)&&O(h,"active",S[0]==="/classes"),(!M||N&1)&&O(A,"active",S[0]==="/racas"),(!M||N&1)&&O(c,"active",S[0]==="/magias"),(!M||N&1)&&O(z,"active",S[0]==="/tradegoods")},i(S){M||(L(o.$$.fragment,S),L(s.$$.fragment,S),L(i.$$.fragment,S),L(E.$$.fragment,S),L(v.$$.fragment,S),L(j.$$.fragment,S),L(f.$$.fragment,S),M=!0)},o(S){D(o.$$.fragment,S),D(s.$$.fragment,S),D(i.$$.fragment,S),D(E.$$.fragment,S),D(v.$$.fragment,S),D(j.$$.fragment,S),D(f.$$.fragment,S),M=!1},d(S){S&&V(a),_(o),_(s),_(i),_(E),_(v),_(j),_(f)}}}function Ie(e,a,o){let r="/iniciativa";const s=[{slug:"/iniciativa",label:"Iniciativa"},{slug:"/classes",label:"Classes"},{slug:"/racas",label:"Raças"},{slug:"/magias",label:"Magias"},{slug:"/tradegoods",label:"Comércio"}];function t(n){r=n,o(0,r)}return[r,s,t]}class ye extends Q{constructor(a){super(),k(this,a,Ie,Ne,R,{})}}function Te(e){let a,o,r;return o=new ye({}),{c(){a=q("main"),U(o.$$.fragment)},m(s,t){x(s,a,t),J(o,a,null),r=!0},p:y,i(s){r||(L(o.$$.fragment,s),r=!0)},o(s){D(o.$$.fragment,s),r=!1},d(s){s&&V(a),_(o)}}}class Re extends Q{constructor(a){super(),k(this,a,null,Te,R,{})}}new Re({target:document.getElementById("app")});
