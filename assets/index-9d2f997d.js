(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerpolicy&&(t.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?t.credentials="include":s.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();function N(){}function Ha(a,e){for(const o in e)a[o]=e[o];return a}function Oa(a){return a()}function ha(){return Object.create(null)}function B(a){a.forEach(Oa)}function Ja(a){return typeof a=="function"}function T(a,e){return a!=a?e==e:a!==e||a&&typeof a=="object"||typeof a=="function"}let na;function ra(a,e){return na||(na=document.createElement("a")),na.href=e,a===na.href}function Wa(a){return Object.keys(a).length===0}function _a(a,e,o,r){if(a){const s=Ua(a,e,o,r);return a[0](s)}}function Ua(a,e,o,r){return a[1]&&r?Ha(o.ctx.slice(),a[1](r(e))):o.ctx}function Fa(a,e,o,r){if(a[2]&&r){const s=a[2](r(o));if(e.dirty===void 0)return s;if(typeof s=="object"){const t=[],n=Math.max(e.dirty.length,s.length);for(let d=0;d<n;d+=1)t[d]=e.dirty[d]|s[d];return t}return e.dirty|s}return e.dirty}function Ia(a,e,o,r,s,t){if(s){const n=Ua(e,o,r,t);a.p(n,s)}}function Na(a){if(a.ctx.length>32){const e=[],o=a.ctx.length/32;for(let r=0;r<o;r++)e[r]=-1;return e}return-1}function l(a,e){a.appendChild(e)}function D(a,e,o){a.insertBefore(e,o||null)}function P(a){a.parentNode&&a.parentNode.removeChild(a)}function ea(a,e){for(let o=0;o<a.length;o+=1)a[o]&&a[o].d(e)}function f(a){return document.createElement(a)}function Ka(a){return document.createElementNS("http://www.w3.org/2000/svg",a)}function w(a){return document.createTextNode(a)}function x(){return w(" ")}function qa(){return w("")}function O(a,e,o,r){return a.addEventListener(e,o,r),()=>a.removeEventListener(e,o,r)}function W(a){return function(e){return e.preventDefault(),a.call(this,e)}}function m(a,e,o){o==null?a.removeAttribute(e):a.getAttribute(e)!==o&&a.setAttribute(e,o)}function $(a){return a===""?null:+a}function Xa(a){return Array.from(a.childNodes)}function sa(a,e){e=""+e,a.wholeText!==e&&(a.data=e)}function L(a,e){a.value=e??""}function F(a,e,o){a.classList[o?"add":"remove"](e)}function Za(a,e,{bubbles:o=!1,cancelable:r=!1}={}){const s=document.createEvent("CustomEvent");return s.initCustomEvent(a,o,r,e),s}class Ya{constructor(e=!1){this.is_svg=!1,this.is_svg=e,this.e=this.n=null}c(e){this.h(e)}m(e,o,r=null){this.e||(this.is_svg?this.e=Ka(o.nodeName):this.e=f(o.nodeName),this.t=o,this.c(e)),this.i(r)}h(e){this.e.innerHTML=e,this.n=Array.from(this.e.childNodes)}i(e){for(let o=0;o<this.n.length;o+=1)D(this.t,this.n[o],e)}p(e){this.d(),this.h(e),this.i(this.a)}d(){this.n.forEach(P)}}let oa;function aa(a){oa=a}function ae(){if(!oa)throw new Error("Function called outside component initialization");return oa}function ee(){const a=ae();return(e,o,{cancelable:r=!1}={})=>{const s=a.$$.callbacks[e];if(s){const t=Za(e,o,{cancelable:r});return s.slice().forEach(n=>{n.call(a,t)}),!t.defaultPrevented}return!0}}const Y=[],ca=[],ua=[],la=[],oe=Promise.resolve();let ga=!1;function re(){ga||(ga=!0,oe.then(Ta))}function va(a){ua.push(a)}function ya(a){la.push(a)}const pa=new Set;let da=0;function Ta(){const a=oa;do{for(;da<Y.length;){const e=Y[da];da++,aa(e),se(e.$$)}for(aa(null),Y.length=0,da=0;ca.length;)ca.pop()();for(let e=0;e<ua.length;e+=1){const o=ua[e];pa.has(o)||(pa.add(o),o())}ua.length=0}while(Y.length);for(;la.length;)la.pop()();ga=!1,pa.clear(),aa(a)}function se(a){if(a.fragment!==null){a.update(),B(a.before_update);const e=a.dirty;a.dirty=[-1],a.fragment&&a.fragment.p(a.ctx,e),a.after_update.forEach(va)}}const ma=new Set;let H;function ka(){H={r:0,c:[],p:H}}function Ra(){H.r||B(H.c),H=H.p}function M(a,e){a&&a.i&&(ma.delete(a),a.i(e))}function J(a,e,o,r){if(a&&a.o){if(ma.has(a))return;ma.add(a),H.c.push(()=>{ma.delete(a),r&&(o&&a.d(1),r())}),a.o(e)}else r&&r()}function Qa(a,e,o,r){const s=a.$$.props[e];s!==void 0&&(a.$$.bound[s]=o,r===void 0&&o(a.$$.ctx[s]))}function I(a){a&&a.c()}function _(a,e,o,r){const{fragment:s,after_update:t}=a.$$;s&&s.m(e,o),r||va(()=>{const n=a.$$.on_mount.map(Oa).filter(Ja);a.$$.on_destroy?a.$$.on_destroy.push(...n):B(n),a.$$.on_mount=[]}),t.forEach(va)}function U(a,e){const o=a.$$;o.fragment!==null&&(B(o.on_destroy),o.fragment&&o.fragment.d(e),o.on_destroy=o.fragment=null,o.ctx=[])}function te(a,e){a.$$.dirty[0]===-1&&(Y.push(a),re(),a.$$.dirty.fill(0)),a.$$.dirty[e/31|0]|=1<<e%31}function k(a,e,o,r,s,t,n,d=[-1]){const g=oa;aa(a);const i=a.$$={fragment:null,ctx:[],props:t,update:N,not_equal:s,bound:ha(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(g?g.$$.context:[])),callbacks:ha(),dirty:d,skip_bound:!1,root:e.target||g.$$.root};n&&n(i.root);let j=!1;if(i.ctx=o?o(a,e.props||{},(q,C,...A)=>{const z=A.length?A[0]:C;return i.ctx&&s(i.ctx[q],i.ctx[q]=z)&&(!i.skip_bound&&i.bound[q]&&i.bound[q](z),j&&te(a,q)),C}):[],i.update(),j=!0,B(i.before_update),i.fragment=r?r(i.ctx):!1,e.target){if(e.hydrate){const q=Xa(e.target);i.fragment&&i.fragment.l(q),q.forEach(P)}else i.fragment&&i.fragment.c();e.intro&&M(a.$$.fragment),_(a,e.target,e.anchor,e.customElement),Ta()}aa(g)}class R{$destroy(){U(this,1),this.$destroy=N}$on(e,o){if(!Ja(o))return N;const r=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return r.push(o),()=>{const s=r.indexOf(o);s!==-1&&r.splice(s,1)}}$set(e){this.$$set&&!Wa(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function ne(a){let e;return{c(){e=w("Hello World")},m(o,r){D(o,e,r)},d(o){o&&P(e)}}}function de(a){let e,o,r,s;const t=a[1].default,n=_a(t,a,a[0],null),d=n||ne();return{c(){e=f("header"),o=f("div"),r=f("h1"),d&&d.c(),m(r,"class","header__title svelte-liwc8f"),m(o,"class","header__container svelte-liwc8f"),m(e,"class","header svelte-liwc8f")},m(g,i){D(g,e,i),l(e,o),l(o,r),d&&d.m(r,null),s=!0},p(g,[i]){n&&n.p&&(!s||i&1)&&Ia(n,t,g,g[0],s?Fa(t,g[0],i,null):Na(g[0]),null)},i(g){s||(M(d,g),s=!0)},o(g){J(d,g),s=!1},d(g){g&&P(e),d&&d.d(g)}}}function ie(a,e,o){let{$$slots:r={},$$scope:s}=e;return a.$$set=t=>{"$$scope"in t&&o(0,s=t.$$scope)},[s,r]}class ue extends R{constructor(e){super(),k(this,e,ie,de,T,{})}}function ba(a,e,o){const r=a.slice();return r[3]=e[o],r}function Aa(a){let e,o,r=a[3].label+"",s,t,n,d;function g(){return a[2](a[3])}return{c(){e=f("li"),o=f("a"),s=w(r),t=x(),m(o,"href","#"),m(o,"class","nav__link svelte-1n62zsf"),m(e,"class","nav__item svelte-1n62zsf"),F(e,"nav__item--active",a[3].slug==a[0])},m(i,j){D(i,e,j),l(e,o),l(o,s),l(e,t),n||(d=O(o,"click",W(g)),n=!0)},p(i,j){a=i,j&2&&r!==(r=a[3].label+"")&&sa(s,r),j&3&&F(e,"nav__item--active",a[3].slug==a[0])},d(i){i&&P(e),n=!1,d()}}}function me(a){let e,o,r=a[1],s=[];for(let t=0;t<r.length;t+=1)s[t]=Aa(ba(a,r,t));return{c(){e=f("nav"),o=f("ul");for(let t=0;t<s.length;t+=1)s[t].c();m(o,"class","nav__list svelte-1n62zsf"),m(e,"class","nav svelte-1n62zsf")},m(t,n){D(t,e,n),l(e,o);for(let d=0;d<s.length;d+=1)s[d].m(o,null)},p(t,[n]){if(n&3){r=t[1];let d;for(d=0;d<r.length;d+=1){const g=ba(t,r,d);s[d]?s[d].p(g,n):(s[d]=Aa(g),s[d].c(),s[d].m(o,null))}for(;d<s.length;d+=1)s[d].d(1);s.length=r.length}},i:N,o:N,d(t){t&&P(e),ea(s,t)}}}function ce(a,e,o){let{value:r}=e,{items:s}=e;const t=n=>o(0,r=n.slug);return a.$$set=n=>{"value"in n&&o(0,r=n.value),"items"in n&&o(1,s=n.items)},[r,s,t]}class pe extends R{constructor(e){super(),k(this,e,ce,me,T,{value:0,items:1})}}function le(a){let e,o,r;const s=a[2].default,t=_a(s,a,a[1],null);return{c(){e=f("ul"),t&&t.c(),m(e,"class",o="list "+a[0]+" svelte-t0otg3")},m(n,d){D(n,e,d),t&&t.m(e,null),r=!0},p(n,[d]){t&&t.p&&(!r||d&2)&&Ia(t,s,n,n[1],r?Fa(s,n[1],d,null):Na(n[1]),null),(!r||d&1&&o!==(o="list "+n[0]+" svelte-t0otg3"))&&m(e,"class",o)},i(n){r||(M(t,n),r=!0)},o(n){J(t,n),r=!1},d(n){n&&P(e),t&&t.d(n)}}}function ge(a,e,o){let{$$slots:r={},$$scope:s}=e,{className:t=""}=e;return a.$$set=n=>{"className"in n&&o(0,t=n.className),"$$scope"in n&&o(1,s=n.$$scope)},[t,s,r]}class $a extends R{constructor(e){super(),k(this,e,ge,le,T,{className:0})}}const ve="/dnd/assets/x-25909307.svg";function ja(a,e,o){const r=a.slice();return r[2]=e[o],r}function za(a){let e,o=a[0][a[2]]+"",r;return{c(){e=new Ya(!1),r=qa(),e.a=r},m(s,t){e.m(o,s,t),D(s,r,t)},p(s,t){t&1&&o!==(o=s[0][s[2]]+"")&&e.p(o)},d(s){s&&P(r),s&&e.d()}}}function fe(a){let e,o,r,s,t,n,d,g,i,j=a[0].name+"",q,C,A,z,b=Object.keys(a[0]),h=[];for(let v=0;v<b.length;v+=1)h[v]=za(ja(a,b,v));return{c(){e=f("div"),o=f("div"),r=x(),s=f("div"),t=f("button"),n=f("img"),g=x(),i=f("h2"),q=w(j),C=x();for(let v=0;v<h.length;v+=1)h[v].c();m(o,"class","overlay svelte-1wu5zh3"),ra(n.src,d=ve)||m(n,"src",d),m(n,"alt","close"),m(t,"class","close svelte-1wu5zh3"),m(i,"class","title svelte-1wu5zh3"),m(s,"class","container svelte-1wu5zh3"),m(e,"class","modal svelte-1wu5zh3"),F(e,"active",a[0].isActive)},m(v,V){D(v,e,V),l(e,o),l(e,r),l(e,s),l(s,t),l(t,n),l(s,g),l(s,i),l(i,q),l(s,C);for(let u=0;u<h.length;u+=1)h[u].m(s,null);A||(z=[O(o,"click",W(a[1])),O(t,"click",W(a[1]))],A=!0)},p(v,[V]){if(V&1&&j!==(j=v[0].name+"")&&sa(q,j),V&1){b=Object.keys(v[0]);let u;for(u=0;u<b.length;u+=1){const c=ja(v,b,u);h[u]?h[u].p(c,V):(h[u]=za(c),h[u].c(),h[u].m(s,null))}for(;u<h.length;u+=1)h[u].d(1);h.length=b.length}V&1&&F(e,"active",v[0].isActive)},i:N,o:N,d(v){v&&P(e),ea(h,v),A=!1,B(z)}}}function qe(a,e,o){let{entry:r}=e;function s(){o(0,r.isActive=!1,r)}return a.$$set=t=>{"entry"in t&&o(0,r=t.entry)},[r,s]}class he extends R{constructor(e){super(),k(this,e,qe,fe,T,{entry:0})}}const be="/dnd/assets/search-3252ceb1.svg";function Sa(a,e,o){const r=a.slice();return r[6]=e[o],r}function Ca(a,e,o){const r=a.slice();return r[6]=e[o],r[9]=e,r[10]=o,r}function Ea(a){let e,o,r,s=a[6].name+"",t,n,d;function g(){return a[5](a[6],a[9],a[10])}return{c(){e=f("li"),o=f("a"),r=f("span"),t=w(s),m(r,"class","init__text"),m(o,"href","#"),m(o,"class","init__content svelte-12ax5ri"),m(e,"class","init__item svelte-12ax5ri")},m(i,j){D(i,e,j),l(e,o),l(o,r),l(r,t),n||(d=O(o,"click",W(g)),n=!0)},p(i,j){a=i,j&4&&s!==(s=a[6].name+"")&&sa(t,s)},d(i){i&&P(e),n=!1,d()}}}function Va(a){let e,o;return e=new he({props:{entry:a[6]}}),{c(){I(e.$$.fragment)},m(r,s){_(e,r,s),o=!0},p(r,s){const t={};s&4&&(t.entry=r[6]),e.$set(t)},i(r){o||(M(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){U(e,r)}}}function Ae(a){let e,o,r,s,t,n,d,g,i,j,q,C,A,z=a[2],b=[];for(let u=0;u<z.length;u+=1)b[u]=Ea(Ca(a,z,u));let h=a[2],v=[];for(let u=0;u<h.length;u+=1)v[u]=Va(Sa(a,h,u));const V=u=>J(v[u],1,1,()=>{v[u]=null});return{c(){e=f("li"),o=f("form"),r=f("input"),s=x(),t=f("button"),n=f("img"),g=x();for(let u=0;u<b.length;u+=1)b[u].c();i=x();for(let u=0;u<v.length;u+=1)v[u].c();j=qa(),m(r,"type","search"),m(r,"class","input svelte-12ax5ri"),m(r,"placeholder",a[0]),ra(n.src,d=be)||m(n,"src",d),m(n,"alt","add user"),m(n,"class","svelte-12ax5ri"),m(t,"class","button button--icon svelte-12ax5ri"),t.disabled=!0,m(o,"class","init__form svelte-12ax5ri"),m(e,"class","init__item svelte-12ax5ri")},m(u,c){D(u,e,c),l(e,o),l(o,r),L(r,a[1]),l(o,s),l(o,t),l(t,n),D(u,g,c);for(let p=0;p<b.length;p+=1)b[p].m(u,c);D(u,i,c);for(let p=0;p<v.length;p+=1)v[p].m(u,c);D(u,j,c),q=!0,C||(A=[O(r,"input",a[4]),O(o,"submit",W(ze))],C=!0)},p(u,c){if((!q||c&1)&&m(r,"placeholder",u[0]),c&2&&L(r,u[1]),c&4){z=u[2];let p;for(p=0;p<z.length;p+=1){const S=Ca(u,z,p);b[p]?b[p].p(S,c):(b[p]=Ea(S),b[p].c(),b[p].m(i.parentNode,i))}for(;p<b.length;p+=1)b[p].d(1);b.length=z.length}if(c&4){h=u[2];let p;for(p=0;p<h.length;p+=1){const S=Sa(u,h,p);v[p]?(v[p].p(S,c),M(v[p],1)):(v[p]=Va(S),v[p].c(),M(v[p],1),v[p].m(j.parentNode,j))}for(ka(),p=h.length;p<v.length;p+=1)V(p);Ra()}},i(u){if(!q){for(let c=0;c<h.length;c+=1)M(v[c]);q=!0}},o(u){v=v.filter(Boolean);for(let c=0;c<v.length;c+=1)J(v[c]);q=!1},d(u){u&&P(e),u&&P(g),ea(b,u),u&&P(i),ea(v,u),u&&P(j),C=!1,B(A)}}}function je(a){let e,o;return e=new $a({props:{className:"db",$$slots:{default:[Ae]},$$scope:{ctx:a}}}),{c(){I(e.$$.fragment)},m(r,s){_(e,r,s),o=!0},p(r,[s]){const t={};s&2055&&(t.$$scope={dirty:s,ctx:r}),e.$set(t)},i(r){o||(M(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){U(e,r)}}}const ze=()=>{};function Se(a,e,o){let r,{data:s}=e,{label:t}=e,n="";function d(){n=this.value,o(1,n)}const g=(i,j,q)=>o(2,j[q].isActive=!0,r);return a.$$set=i=>{"data"in i&&o(3,s=i.data),"label"in i&&o(0,t=i.label)},a.$$.update=()=>{a.$$.dirty&10&&o(2,r=Object.keys(s.entries).map(i=>({...s.entries[i],isModalOpen:!1})).filter(i=>i.name.toLowerCase().includes(n.toLowerCase())))},[t,n,r,s,d,g]}class ia extends R{constructor(e){super(),k(this,e,Se,je,T,{data:3,label:0})}}const Ce="/dnd/assets/user-plus-3c6aeeff.svg",Ee="/dnd/assets/user-minus-e4725f11.svg";function xa(a,e,o){const r=a.slice();return r[18]=e[o],r[19]=e,r[20]=o,r}function Pa(a){let e,o,r,s=a[18].iniciative.sum+"",t,n,d,g,i,j,q,C,A,z,b,h,v,V,u,c,p,S,G,K;function E(){a[11].call(d,a[19],a[20])}function y(){a[12].call(i,a[19],a[20])}function ta(){return a[13](a[20])}function X(){a[14].call(h,a[19],a[20])}function Ga(){a[15].call(u,a[19],a[20])}function wa(){a[16].call(p,a[19],a[20])}return{c(){e=f("li"),o=f("form"),r=f("span"),t=w(s),n=x(),d=f("input"),g=x(),i=f("input"),j=x(),q=f("button"),C=f("img"),z=x(),b=f("div"),h=f("input"),V=x(),u=f("input"),c=x(),p=f("input"),S=x(),m(r,"class","iniciative svelte-1odz8hk"),m(d,"type","text"),m(d,"class","input input--clear svelte-1odz8hk"),m(d,"placeholder","Personagem"),m(i,"type","text"),m(i,"class","input input--clear input--dice svelte-1odz8hk"),m(i,"placeholder","1d20"),ra(C.src,A=Ee)||m(C,"src",A),m(C,"alt","remove user"),m(q,"class","button button--icon button--secondary"),m(q,"type","button"),m(o,"class","init__form svelte-1odz8hk"),m(h,"type","range"),m(h,"name","HP"),m(h,"min","0"),m(h,"max",v=a[18].maxHp),m(h,"id","hp"),m(u,"type","number"),m(u,"class","input input--clear svelte-1odz8hk"),m(u,"placeholder","HP"),m(p,"type","number"),m(p,"class","input input--clear svelte-1odz8hk"),m(p,"placeholder","Max HP"),m(b,"class","hp svelte-1odz8hk"),m(e,"class","init__item svelte-1odz8hk")},m(Z,Q){D(Z,e,Q),l(e,o),l(o,r),l(r,t),l(o,n),l(o,d),L(d,a[18].name),l(o,g),l(o,i),L(i,a[18].dice),l(o,j),l(o,q),l(q,C),l(e,z),l(e,b),l(b,h),L(h,a[18].hp),l(b,V),l(b,u),L(u,a[18].hp),l(b,c),l(b,p),L(p,a[18].maxHp),l(e,S),G||(K=[O(d,"input",E),O(i,"input",y),O(q,"click",ta),O(o,"submit",W(De)),O(h,"change",X),O(h,"input",X),O(u,"input",Ga),O(p,"input",wa)],G=!0)},p(Z,Q){a=Z,Q&1&&s!==(s=a[18].iniciative.sum+"")&&sa(t,s),Q&1&&d.value!==a[18].name&&L(d,a[18].name),Q&1&&i.value!==a[18].dice&&L(i,a[18].dice),Q&1&&v!==(v=a[18].maxHp)&&m(h,"max",v),Q&1&&L(h,a[18].hp),Q&1&&$(u.value)!==a[18].hp&&L(u,a[18].hp),Q&1&&$(p.value)!==a[18].maxHp&&L(p,a[18].maxHp)},d(Z){Z&&P(e),G=!1,B(K)}}}function Ve(a){let e,o,r,s,t,n,d,g,i,j,q,C,A,z,b,h,v,V=a[0],u=[];for(let c=0;c<V.length;c+=1)u[c]=Pa(xa(a,V,c));return{c(){e=f("li"),o=f("form"),r=f("input"),s=x(),t=f("input"),n=x(),d=f("input"),g=x(),i=f("input"),j=x(),q=f("button"),C=f("img"),z=x();for(let c=0;c<u.length;c+=1)u[c].c();b=qa(),m(r,"type","text"),m(r,"class","input svelte-1odz8hk"),m(r,"placeholder","Personagem"),m(t,"type","text"),m(t,"class","input input--dice svelte-1odz8hk"),m(t,"placeholder","1d20"),m(d,"type","number"),m(d,"min","0"),m(d,"class","input input--dice svelte-1odz8hk"),m(d,"placeholder","HP"),m(i,"type","number"),m(i,"min","0"),m(i,"class","input input--dice svelte-1odz8hk"),m(i,"placeholder","Max HP"),ra(C.src,A=Ce)||m(C,"src",A),m(C,"alt","add user"),m(q,"class","button button--icon"),m(o,"class","init__form svelte-1odz8hk"),m(e,"class","init__item svelte-1odz8hk")},m(c,p){D(c,e,p),l(e,o),l(o,r),L(r,a[1]),l(o,s),l(o,t),L(t,a[2]),l(o,n),l(o,d),L(d,a[3]),l(o,g),l(o,i),L(i,a[4]),l(o,j),l(o,q),l(q,C),D(c,z,p);for(let S=0;S<u.length;S+=1)u[S].m(c,p);D(c,b,p),h||(v=[O(r,"input",a[7]),O(t,"input",a[8]),O(d,"input",a[9]),O(i,"input",a[10]),O(o,"submit",W(a[5]))],h=!0)},p(c,p){if(p&2&&r.value!==c[1]&&L(r,c[1]),p&4&&t.value!==c[2]&&L(t,c[2]),p&8&&$(d.value)!==c[3]&&L(d,c[3]),p&16&&$(i.value)!==c[4]&&L(i,c[4]),p&65){V=c[0];let S;for(S=0;S<V.length;S+=1){const G=xa(c,V,S);u[S]?u[S].p(G,p):(u[S]=Pa(G),u[S].c(),u[S].m(b.parentNode,b))}for(;S<u.length;S+=1)u[S].d(1);u.length=V.length}},d(c){c&&P(e),c&&P(z),ea(u,c),c&&P(b),h=!1,B(v)}}}function xe(a){let e,o;return e=new $a({props:{className:"init",$$slots:{default:[Ve]},$$scope:{ctx:a}}}),{c(){I(e.$$.fragment)},m(r,s){_(e,r,s),o=!0},p(r,[s]){const t={};s&2097183&&(t.$$scope={dirty:s,ctx:r}),e.$set(t)},i(r){o||(M(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){U(e,r)}}}const Da=50,Pe="1d20",De=()=>{};function Me(a,e,o){let{chars:r}=e,s="",t="",n,d;function g(){t===""&&o(2,t=Pe),o(0,r=[{name:s,dice:t,maxHp:d||Da,hp:n||Da,iniciative:0},...r]),o(1,s=""),o(2,t="")}function i(c){o(0,r=r.map((p,S)=>({...p,i:S})).filter(({i:p})=>p!==c))}function j(){s=this.value,o(1,s)}function q(){t=this.value,o(2,t)}function C(){n=$(this.value),o(3,n)}function A(){d=$(this.value),o(4,d)}function z(c,p){c[p].name=this.value,o(0,r)}function b(c,p){c[p].dice=this.value,o(0,r)}const h=c=>i(c);function v(c,p){c[p].hp=$(this.value),o(0,r)}function V(c,p){c[p].hp=$(this.value),o(0,r)}function u(c,p){c[p].maxHp=$(this.value),o(0,r)}return a.$$set=c=>{"chars"in c&&o(0,r=c.chars)},[r,s,t,n,d,g,i,j,q,C,A,z,b,h,v,V,u]}class Le extends R{constructor(e){super(),k(this,e,Me,xe,T,{chars:0})}}const Oe="/dnd/assets/play-41903c19.svg";function Je(a){let e,o,r,s,t,n;return{c(){e=f("div"),o=f("button"),r=f("img"),ra(r.src,s=Oe)||m(r,"src",s),m(r,"alt",""),m(r,"class","icon-play svelte-ugm1i9"),m(o,"class","button button--alt svelte-ugm1i9"),m(e,"class","container svelte-ugm1i9")},m(d,g){D(d,e,g),l(e,o),l(o,r),t||(n=O(o,"click",a[1]),t=!0)},p:N,i:N,o:N,d(d){d&&P(e),t=!1,n()}}}function _e(a){const e=ee();return[e,r=>e("play",r)]}class Ba extends R{constructor(e){super(),k(this,e,_e,Je,T,{})}}function Ma(a,e,o=JSON.stringify){window.localStorage.setItem(a,o(e))}function La(a,e=null,o=JSON.parse){const r=window.localStorage.getItem(a);return r?o(r):e}function Ue(a,e){return a=Math.ceil(a),e=Math.floor(e),Math.floor(Math.random()*(e-a+1))+a}function Fe(a){if(!/\d+d\d+((\+|\-)\d+)?/g.test(a))throw`Invalid Dice: ${a}`;const[o,r]=a.split("d"),s=parseInt(o),t=/\+|\-/g,n=t.test(r),d=n?r.search(t):0,g=parseInt(r.substring(0,n?d:r.length)),i=n?parseInt(r.substring(d)):0;return[s,g,i]}function Ie(a){const[e,o,r]=Fe(a);return Ne(e,o,r)}function Ne(a,e,o=0){const s=new Array(a).fill(0).map(()=>Ue(1,e));return{sum:s.reduce((n,d)=>n+d,0)+o,roll:s,bonus:o,dice:`${a}d${e}${o>=0?`+${o}`:o}`}}function ye(a){let e,o;return e=new Ba({}),e.$on("play",a[4]),{c(){I(e.$$.fragment)},m(r,s){_(e,r,s),o=!0},p:N,i(r){o||(M(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){U(e,r)}}}function Te(a){let e,o;return e=new Ba({}),e.$on("play",a[2]),{c(){I(e.$$.fragment)},m(r,s){_(e,r,s),o=!0},p:N,i(r){o||(M(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){U(e,r)}}}function ke(a){let e,o,r,s,t,n,d;function g(A){a[3](A)}let i={};a[0]!==void 0&&(i.chars=a[0]),e=new Le({props:i}),ca.push(()=>Qa(e,"chars",g,a[0]));const j=[Te,ye],q=[];function C(A,z){return A[1]===fa?0:1}return t=C(a),n=q[t]=j[t](a),{c(){I(e.$$.fragment),r=x(),s=f("div"),n.c(),m(s,"class","control svelte-jpumiv")},m(A,z){_(e,A,z),D(A,r,z),D(A,s,z),q[t].m(s,null),d=!0},p(A,[z]){const b={};!o&&z&1&&(o=!0,b.chars=A[0],ya(()=>o=!1)),e.$set(b);let h=t;t=C(A),t===h?q[t].p(A,z):(ka(),J(q[h],1,1,()=>{q[h]=null}),Ra(),n=q[t],n?n.p(A,z):(n=q[t]=j[t](A),n.c()),M(n,1),n.m(s,null))},i(A){d||(M(e.$$.fragment,A),M(n),d=!0)},o(A){J(e.$$.fragment,A),J(n),d=!1},d(A){U(e,A),A&&P(r),A&&P(s),q[t].d()}}}const fa="create",Re="run";function Qe(a,e,o){let r=La("mode",fa),{chars:s=La("chars",[])}=e;function t(){o(1,r=Re),n()}function n(){o(0,s=[...s].map(i=>({...i,iniciative:Ie(i.dice)})).sort((i,j)=>j.iniciative.sum-i.iniciative.sum))}function d(i){s=i,o(0,s)}const g=()=>o(1,r=fa);return a.$$set=i=>{"chars"in i&&o(0,s=i.chars)},a.$$.update=()=>{a.$$.dirty&1&&Ma("chars",s),a.$$.dirty&2&&Ma("mode",r)},[s,r,t,d,g]}class $e extends R{constructor(e){super(),k(this,e,Qe,ke,T,{chars:0})}}const Be="Classes (SRD)",Ge={Sorcerer:{description:`<p>Ao criar um aventureiro feiticeiro, você recebe as seguintes características de classe.</p>
...
<p>14º Nível: <a class="entity-link" draggable="true" data-pack="dnd5e.classfeatures" data-id="EuX1kJNIw1F68yus"><i class="fas fa-suitcase"></i> Santuário Natural</a></p>`,name:"Druida"}},we={label:Be,entries:Ge},He="Traços raciais (SRD)",We={Dwarf:{description:`<p><em>Um personagem anão possui uma variedade de habilidades inatas, parte integrante da natureza dos anões.</em></p>
...
<p><em><strong>Deslocamento.</strong></em> Seu deslocamento base de caminhada é 9 metros.</p>
<p><em><strong>Idiomas. </strong></em>Você pode falar, ler e escrever Comum e outro idioma adicional, à sua escolha. Os humanos normalmente aprendem os idiomas dos povos que convivem, incluindo dialetos obscuros. Eles gostam de rechear seu discurso com palavras emprestadas de outras línguas: xingamentos orcs, expressões musicais élficas, frases militares anãs e outros.</p>`,source:"LdJ pg. 31",name:"Humano"}},Ke={source:"data.source",range:{path:"data.range",converter:"range"},target:{path:"data.target",converter:"target"}},Xe={label:He,entries:We,mapping:Ke},Ze="Magias (SRD)",Ye={Polymorph:{description:`<p>A magia transforma uma criatura à sua vista, no alcance da magia, em uma nova forma. Uma criatura não voluntária deve fazer uma salvaguarda de Sabedoria para evitar o efeito. A magia não tem efeito sobre um Metamorfo ou em uma criatura com 0 pontos de vida.</p>
...
<p>O cravo ou cravo-da-índia (Syzygium aromaticum), é uma árvore perene da família da murta, eles são secos e possuem botão fechado.</p>`,source:"LdJ pg. 157",name:"Cravo"}},so={source:"data.source",weight:{path:"data.weight",converter:"weight"}},to={label:oo,entries:ro,mapping:so};function no(a){let e=a[1].find(a[2]).label+"",o;return{c(){o=w(e)},m(r,s){D(r,o,s)},p(r,s){s&1&&e!==(e=r[1].find(r[2]).label+"")&&sa(o,e)},d(r){r&&P(o)}}}function io(a){let e,o,r,s,t,n,d,g,i,j,q,C,A,z,b,h,v,V,u,c,p,S;o=new ue({props:{$$slots:{default:[no]},$$scope:{ctx:a}}});function G(E){a[3](E)}let K={items:a[1]};return a[0]!==void 0&&(K.value=a[0]),s=new pe({props:K}),ca.push(()=>Qa(s,"value",G,a[0])),i=new $e({}),C=new ia({props:{data:we,label:"Classes"}}),b=new ia({props:{data:Xe,label:"Raças"}}),V=new ia({props:{data:eo,label:"Magias"}}),p=new ia({props:{data:to,label:"Comércio"}}),{c(){e=f("div"),I(o.$$.fragment),r=x(),I(s.$$.fragment),n=x(),d=f("div"),g=f("div"),I(i.$$.fragment),j=x(),q=f("div"),I(C.$$.fragment),A=x(),z=f("div"),I(b.$$.fragment),h=x(),v=f("div"),I(V.$$.fragment),u=x(),c=f("div"),I(p.$$.fragment),m(g,"class","item svelte-18gp8wx"),F(g,"active",a[0]==="/iniciativa"),m(q,"class","item svelte-18gp8wx"),F(q,"active",a[0]==="/classes"),m(z,"class","item svelte-18gp8wx"),F(z,"active",a[0]==="/racas"),m(v,"class","item svelte-18gp8wx"),F(v,"active",a[0]==="/magias"),m(c,"class","item svelte-18gp8wx"),F(c,"active",a[0]==="/tradegoods"),m(d,"class","content svelte-18gp8wx"),m(e,"class","page svelte-18gp8wx")},m(E,y){D(E,e,y),_(o,e,null),l(e,r),_(s,e,null),l(e,n),l(e,d),l(d,g),_(i,g,null),l(d,j),l(d,q),_(C,q,null),l(d,A),l(d,z),_(b,z,null),l(d,h),l(d,v),_(V,v,null),l(d,u),l(d,c),_(p,c,null),S=!0},p(E,[y]){const ta={};y&17&&(ta.$$scope={dirty:y,ctx:E}),o.$set(ta);const X={};!t&&y&1&&(t=!0,X.value=E[0],ya(()=>t=!1)),s.$set(X),(!S||y&1)&&F(g,"active",E[0]==="/iniciativa"),(!S||y&1)&&F(q,"active",E[0]==="/classes"),(!S||y&1)&&F(z,"active",E[0]==="/racas"),(!S||y&1)&&F(v,"active",E[0]==="/magias"),(!S||y&1)&&F(c,"active",E[0]==="/tradegoods")},i(E){S||(M(o.$$.fragment,E),M(s.$$.fragment,E),M(i.$$.fragment,E),M(C.$$.fragment,E),M(b.$$.fragment,E),M(V.$$.fragment,E),M(p.$$.fragment,E),S=!0)},o(E){J(o.$$.fragment,E),J(s.$$.fragment,E),J(i.$$.fragment,E),J(C.$$.fragment,E),J(b.$$.fragment,E),J(V.$$.fragment,E),J(p.$$.fragment,E),S=!1},d(E){E&&P(e),U(o),U(s),U(i),U(C),U(b),U(V),U(p)}}}function uo(a,e,o){let r="/iniciativa";const s=[{slug:"/iniciativa",label:"Iniciativa"},{slug:"/classes",label:"Classes"},{slug:"/racas",label:"Raças"},{slug:"/magias",label:"Magias"},{slug:"/tradegoods",label:"Comércio"}],t=d=>d.slug===r;function n(d){r=d,o(0,r)}return[r,s,t,n]}class mo extends R{constructor(e){super(),k(this,e,uo,io,T,{})}}function co(a){let e,o,r;return o=new mo({}),{c(){e=f("main"),I(o.$$.fragment)},m(s,t){D(s,e,t),_(o,e,null),r=!0},p:N,i(s){r||(M(o.$$.fragment,s),r=!0)},o(s){J(o.$$.fragment,s),r=!1},d(s){s&&P(e),U(o)}}}class po extends R{constructor(e){super(),k(this,e,null,co,T,{})}}new po({target:document.getElementById("app")});
