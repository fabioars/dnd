(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerpolicy&&(t.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?t.credentials="include":s.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();function y(){}function _a(e,a){for(const o in a)e[o]=a[o];return e}function Ea(e){return e()}function ga(){return Object.create(null)}function T(e){e.forEach(Ea)}function Va(e){return typeof e=="function"}function R(e,a){return e!=e?a==a:e!==a||e&&typeof e=="object"||typeof e=="function"}let aa;function X(e,a){return aa||(aa=document.createElement("a")),aa.href=a,e===aa.href}function Fa(e){return Object.keys(e).length===0}function xa(e,a,o,r){if(e){const s=Pa(e,a,o,r);return e[0](s)}}function Pa(e,a,o,r){return e[1]&&r?_a(o.ctx.slice(),e[1](r(a))):o.ctx}function La(e,a,o,r){if(e[2]&&r){const s=e[2](r(o));if(a.dirty===void 0)return s;if(typeof s=="object"){const t=[],n=Math.max(a.dirty.length,s.length);for(let d=0;d<n;d+=1)t[d]=a.dirty[d]|s[d];return t}return a.dirty|s}return a.dirty}function Da(e,a,o,r,s,t){if(s){const n=Pa(a,o,r,t);e.p(n,s)}}function Ma(e){if(e.ctx.length>32){const a=[],o=e.ctx.length/32;for(let r=0;r<o;r++)a[r]=-1;return a}return-1}function g(e,a){e.appendChild(a)}function x(e,a,o){e.insertBefore(a,o||null)}function V(e){e.parentNode&&e.parentNode.removeChild(e)}function Z(e,a){for(let o=0;o<e.length;o+=1)e[o]&&e[o].d(a)}function q(e){return document.createElement(e)}function Ua(e){return document.createElementNS("http://www.w3.org/2000/svg",e)}function U(e){return document.createTextNode(e)}function P(){return U(" ")}function ma(){return U("")}function N(e,a,o,r){return e.addEventListener(a,o,r),()=>e.removeEventListener(a,o,r)}function H(e){return function(a){return a.preventDefault(),e.call(this,a)}}function m(e,a,o){o==null?e.removeAttribute(a):e.getAttribute(a)!==o&&e.setAttribute(a,o)}function Na(e){return Array.from(e.childNodes)}function Y(e,a){a=""+a,e.wholeText!==a&&(e.data=a)}function w(e,a){e.value=a??""}function O(e,a,o){e.classList[o?"add":"remove"](a)}class Ia{constructor(a=!1){this.is_svg=!1,this.is_svg=a,this.e=this.n=null}c(a){this.h(a)}m(a,o,r=null){this.e||(this.is_svg?this.e=Ua(o.nodeName):this.e=q(o.nodeName),this.t=o,this.c(a)),this.i(r)}h(a){this.e.innerHTML=a,this.n=Array.from(this.e.childNodes)}i(a){for(let o=0;o<this.n.length;o+=1)x(this.t,this.n[o],a)}p(a){this.d(),this.h(a),this.i(this.a)}d(){this.n.forEach(V)}}let ca;function K(e){ca=e}const W=[],na=[],ra=[],da=[],ya=Promise.resolve();let ia=!1;function Ta(){ia||(ia=!0,ya.then(Oa))}function ua(e){ra.push(e)}function Ra(e){da.push(e)}const ta=new Set;let ea=0;function Oa(){const e=ca;do{for(;ea<W.length;){const a=W[ea];ea++,K(a),ka(a.$$)}for(K(null),W.length=0,ea=0;na.length;)na.pop()();for(let a=0;a<ra.length;a+=1){const o=ra[a];ta.has(o)||(ta.add(o),o())}ra.length=0}while(W.length);for(;da.length;)da.pop()();ia=!1,ta.clear(),K(e)}function ka(e){if(e.fragment!==null){e.update(),T(e.before_update);const a=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,a),e.after_update.forEach(ua)}}const sa=new Set;let G;function Qa(){G={r:0,c:[],p:G}}function $a(){G.r||T(G.c),G=G.p}function L(e,a){e&&e.i&&(sa.delete(e),e.i(a))}function M(e,a,o,r){if(e&&e.o){if(sa.has(e))return;sa.add(e),G.c.push(()=>{sa.delete(e),r&&(o&&e.d(1),r())}),e.o(a)}else r&&r()}function Ba(e,a,o,r){const s=e.$$.props[a];s!==void 0&&(e.$$.bound[s]=o,r===void 0&&o(e.$$.ctx[s]))}function F(e){e&&e.c()}function J(e,a,o,r){const{fragment:s,after_update:t}=e.$$;s&&s.m(a,o),r||ua(()=>{const n=e.$$.on_mount.map(Ea).filter(Va);e.$$.on_destroy?e.$$.on_destroy.push(...n):T(n),e.$$.on_mount=[]}),t.forEach(ua)}function _(e,a){const o=e.$$;o.fragment!==null&&(T(o.on_destroy),o.fragment&&o.fragment.d(a),o.on_destroy=o.fragment=null,o.ctx=[])}function Ga(e,a){e.$$.dirty[0]===-1&&(W.push(e),Ta(),e.$$.dirty.fill(0)),e.$$.dirty[a/31|0]|=1<<a%31}function k(e,a,o,r,s,t,n,d=[-1]){const l=ca;K(e);const u=e.$$={fragment:null,ctx:[],props:t,update:y,not_equal:s,bound:ga(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(a.context||(l?l.$$.context:[])),callbacks:ga(),dirty:d,skip_bound:!1,root:a.target||l.$$.root};n&&n(u.root);let b=!1;if(u.ctx=o?o(e,a.props||{},(h,C,...E)=>{const A=E.length?E[0]:C;return u.ctx&&s(u.ctx[h],u.ctx[h]=A)&&(!u.skip_bound&&u.bound[h]&&u.bound[h](A),b&&Ga(e,h)),C}):[],u.update(),b=!0,T(u.before_update),u.fragment=r?r(u.ctx):!1,a.target){if(a.hydrate){const h=Na(a.target);u.fragment&&u.fragment.l(h),h.forEach(V)}else u.fragment&&u.fragment.c();a.intro&&L(e.$$.fragment),J(e,a.target,a.anchor,a.customElement),Oa()}K(l)}class Q{$destroy(){_(this,1),this.$destroy=y}$on(a,o){if(!Va(o))return y;const r=this.$$.callbacks[a]||(this.$$.callbacks[a]=[]);return r.push(o),()=>{const s=r.indexOf(o);s!==-1&&r.splice(s,1)}}$set(a){this.$$set&&!Fa(a)&&(this.$$.skip_bound=!0,this.$$set(a),this.$$.skip_bound=!1)}}function wa(e){let a;return{c(){a=U("Hello World")},m(o,r){x(o,a,r)},d(o){o&&V(a)}}}function Ha(e){let a,o,r,s;const t=e[1].default,n=xa(t,e,e[0],null),d=n||wa();return{c(){a=q("header"),o=q("div"),r=q("h1"),d&&d.c(),m(r,"class","header__title svelte-liwc8f"),m(o,"class","header__container svelte-liwc8f"),m(a,"class","header svelte-liwc8f")},m(l,u){x(l,a,u),g(a,o),g(o,r),d&&d.m(r,null),s=!0},p(l,[u]){n&&n.p&&(!s||u&1)&&Da(n,t,l,l[0],s?La(t,l[0],u,null):Ma(l[0]),null)},i(l){s||(L(d,l),s=!0)},o(l){M(d,l),s=!1},d(l){l&&V(a),d&&d.d(l)}}}function Wa(e,a,o){let{$$slots:r={},$$scope:s}=a;return e.$$set=t=>{"$$scope"in t&&o(0,s=t.$$scope)},[s,r]}class Ka extends Q{constructor(a){super(),k(this,a,Wa,Ha,R,{})}}function va(e,a,o){const r=e.slice();return r[3]=a[o],r}function fa(e){let a,o,r=e[3].label+"",s,t,n,d;function l(){return e[2](e[3])}return{c(){a=q("li"),o=q("a"),s=U(r),t=P(),m(o,"href","#"),m(o,"class","nav__link svelte-1n62zsf"),m(a,"class","nav__item svelte-1n62zsf"),O(a,"nav__item--active",e[3].slug==e[0])},m(u,b){x(u,a,b),g(a,o),g(o,s),g(a,t),n||(d=N(o,"click",H(l)),n=!0)},p(u,b){e=u,b&2&&r!==(r=e[3].label+"")&&Y(s,r),b&3&&O(a,"nav__item--active",e[3].slug==e[0])},d(u){u&&V(a),n=!1,d()}}}function Xa(e){let a,o,r=e[1],s=[];for(let t=0;t<r.length;t+=1)s[t]=fa(va(e,r,t));return{c(){a=q("nav"),o=q("ul");for(let t=0;t<s.length;t+=1)s[t].c();m(o,"class","nav__list svelte-1n62zsf"),m(a,"class","nav svelte-1n62zsf")},m(t,n){x(t,a,n),g(a,o);for(let d=0;d<s.length;d+=1)s[d].m(o,null)},p(t,[n]){if(n&3){r=t[1];let d;for(d=0;d<r.length;d+=1){const l=va(t,r,d);s[d]?s[d].p(l,n):(s[d]=fa(l),s[d].c(),s[d].m(o,null))}for(;d<s.length;d+=1)s[d].d(1);s.length=r.length}},i:y,o:y,d(t){t&&V(a),Z(s,t)}}}function Za(e,a,o){let{value:r}=a,{items:s}=a;const t=n=>o(0,r=n.slug);return e.$$set=n=>{"value"in n&&o(0,r=n.value),"items"in n&&o(1,s=n.items)},[r,s,t]}class Ya extends Q{constructor(a){super(),k(this,a,Za,Xa,R,{value:0,items:1})}}function ae(e){let a,o,r;const s=e[2].default,t=xa(s,e,e[1],null);return{c(){a=q("ul"),t&&t.c(),m(a,"class",o="list "+e[0]+" svelte-t0otg3")},m(n,d){x(n,a,d),t&&t.m(a,null),r=!0},p(n,[d]){t&&t.p&&(!r||d&2)&&Da(t,s,n,n[1],r?La(s,n[1],d,null):Ma(n[1]),null),(!r||d&1&&o!==(o="list "+n[0]+" svelte-t0otg3"))&&m(a,"class",o)},i(n){r||(L(t,n),r=!0)},o(n){M(t,n),r=!1},d(n){n&&V(a),t&&t.d(n)}}}function ee(e,a,o){let{$$slots:r={},$$scope:s}=a,{className:t=""}=a;return e.$$set=n=>{"className"in n&&o(0,t=n.className),"$$scope"in n&&o(1,s=n.$$scope)},[t,s,r]}class Ja extends Q{constructor(a){super(),k(this,a,ee,ae,R,{className:0})}}const oe="https://fabioars.github.io/dnd/assets/x-25909307.svg";function qa(e,a,o){const r=e.slice();return r[2]=a[o],r}function ha(e){let a,o=e[0][e[2]]+"",r;return{c(){a=new Ia(!1),r=ma(),a.a=r},m(s,t){a.m(o,s,t),x(s,r,t)},p(s,t){t&1&&o!==(o=s[0][s[2]]+"")&&a.p(o)},d(s){s&&V(r),s&&a.d()}}}function re(e){let a,o,r,s,t,n,d,l,u,b=e[0].name+"",h,C,E,A,v=Object.keys(e[0]),p=[];for(let c=0;c<v.length;c+=1)p[c]=ha(qa(e,v,c));return{c(){a=q("div"),o=q("div"),r=P(),s=q("div"),t=q("button"),n=q("img"),l=P(),u=q("h2"),h=U(b),C=P();for(let c=0;c<p.length;c+=1)p[c].c();m(o,"class","overlay svelte-1wu5zh3"),X(n.src,d=oe)||m(n,"src",d),m(n,"alt","close"),m(t,"class","close svelte-1wu5zh3"),m(u,"class","title svelte-1wu5zh3"),m(s,"class","container svelte-1wu5zh3"),m(a,"class","modal svelte-1wu5zh3"),O(a,"active",e[0].isActive)},m(c,j){x(c,a,j),g(a,o),g(a,r),g(a,s),g(s,t),g(t,n),g(s,l),g(s,u),g(u,h),g(s,C);for(let i=0;i<p.length;i+=1)p[i].m(s,null);E||(A=[N(o,"click",H(e[1])),N(t,"click",H(e[1]))],E=!0)},p(c,[j]){if(j&1&&b!==(b=c[0].name+"")&&Y(h,b),j&1){v=Object.keys(c[0]);let i;for(i=0;i<v.length;i+=1){const z=qa(c,v,i);p[i]?p[i].p(z,j):(p[i]=ha(z),p[i].c(),p[i].m(s,null))}for(;i<p.length;i+=1)p[i].d(1);p.length=v.length}j&1&&O(a,"active",c[0].isActive)},i:y,o:y,d(c){c&&V(a),Z(p,c),E=!1,T(A)}}}function se(e,a,o){let{entry:r}=a;function s(){o(0,r.isActive=!1,r)}return e.$$set=t=>{"entry"in t&&o(0,r=t.entry)},[r,s]}class te extends Q{constructor(a){super(),k(this,a,se,re,R,{entry:0})}}const ne="https://fabioars.github.io/dnd/assets/search-3252ceb1.svg";function ba(e,a,o){const r=e.slice();return r[6]=a[o],r}function Aa(e,a,o){const r=e.slice();return r[6]=a[o],r[9]=a,r[10]=o,r}function ja(e){let a,o,r,s=e[6].name+"",t,n,d;function l(){return e[5](e[6],e[9],e[10])}return{c(){a=q("li"),o=q("a"),r=q("span"),t=U(s),m(r,"class","init__text"),m(o,"href","#"),m(o,"class","init__content svelte-15p05hw"),m(a,"class","init__item svelte-15p05hw")},m(u,b){x(u,a,b),g(a,o),g(o,r),g(r,t),n||(d=N(o,"click",H(l)),n=!0)},p(u,b){e=u,b&4&&s!==(s=e[6].name+"")&&Y(t,s)},d(u){u&&V(a),n=!1,d()}}}function za(e){let a,o;return a=new te({props:{entry:e[6]}}),{c(){F(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,s){const t={};s&4&&(t.entry=r[6]),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){M(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}function de(e){let a,o,r,s,t,n,d,l,u,b,h,C,E,A=e[2],v=[];for(let i=0;i<A.length;i+=1)v[i]=ja(Aa(e,A,i));let p=e[2],c=[];for(let i=0;i<p.length;i+=1)c[i]=za(ba(e,p,i));const j=i=>M(c[i],1,1,()=>{c[i]=null});return{c(){a=q("li"),o=q("form"),r=q("input"),s=P(),t=q("button"),n=q("img"),l=P();for(let i=0;i<v.length;i+=1)v[i].c();u=P();for(let i=0;i<c.length;i+=1)c[i].c();b=ma(),m(r,"type","search"),m(r,"class","input svelte-15p05hw"),m(r,"placeholder",e[0]),X(n.src,d=ne)||m(n,"src",d),m(n,"alt","add user"),m(n,"class","svelte-15p05hw"),m(t,"class","button button--icon svelte-15p05hw"),t.disabled=!0,m(o,"class","init__form svelte-15p05hw"),m(a,"class","init__item svelte-15p05hw")},m(i,z){x(i,a,z),g(a,o),g(o,r),w(r,e[1]),g(o,s),g(o,t),g(t,n),x(i,l,z);for(let f=0;f<v.length;f+=1)v[f].m(i,z);x(i,u,z);for(let f=0;f<c.length;f+=1)c[f].m(i,z);x(i,b,z),h=!0,C||(E=[N(r,"input",e[4]),N(o,"submit",H(ue))],C=!0)},p(i,z){if((!h||z&1)&&m(r,"placeholder",i[0]),z&2&&w(r,i[1]),z&4){A=i[2];let f;for(f=0;f<A.length;f+=1){const D=Aa(i,A,f);v[f]?v[f].p(D,z):(v[f]=ja(D),v[f].c(),v[f].m(u.parentNode,u))}for(;f<v.length;f+=1)v[f].d(1);v.length=A.length}if(z&4){p=i[2];let f;for(f=0;f<p.length;f+=1){const D=ba(i,p,f);c[f]?(c[f].p(D,z),L(c[f],1)):(c[f]=za(D),c[f].c(),L(c[f],1),c[f].m(b.parentNode,b))}for(Qa(),f=p.length;f<c.length;f+=1)j(f);$a()}},i(i){if(!h){for(let z=0;z<p.length;z+=1)L(c[z]);h=!0}},o(i){c=c.filter(Boolean);for(let z=0;z<c.length;z+=1)M(c[z]);h=!1},d(i){i&&V(a),i&&V(l),Z(v,i),i&&V(u),Z(c,i),i&&V(b),C=!1,T(E)}}}function ie(e){let a,o;return a=new Ja({props:{className:"db",$$slots:{default:[de]},$$scope:{ctx:e}}}),{c(){F(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,[s]){const t={};s&2055&&(t.$$scope={dirty:s,ctx:r}),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){M(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}const ue=()=>{};function me(e,a,o){let r,{data:s}=a,{label:t}=a,n="";function d(){n=this.value,o(1,n)}const l=(u,b,h)=>o(2,b[h].isActive=!0,r);return e.$$set=u=>{"data"in u&&o(3,s=u.data),"label"in u&&o(0,t=u.label)},e.$$.update=()=>{e.$$.dirty&10&&o(2,r=Object.keys(s.entries).map(u=>({...s.entries[u],isModalOpen:!1})).filter(u=>u.name.toLowerCase().includes(n.toLowerCase())))},[t,n,r,s,d,l]}class oa extends Q{constructor(a){super(),k(this,a,me,ie,R,{data:3,label:0})}}const ce="https://fabioars.github.io/dnd/assets/user-plus-3c6aeeff.svg",pe="https://fabioars.github.io/dnd/assets/user-minus-e4725f11.svg",le="https://fabioars.github.io/dnd/assets/edit-623e8f30.svg";function Sa(e,a,o){const r=e.slice();return r[10]=a[o],r[12]=o,r}function Ca(e){let a,o,r,s=e[10].name+"",t,n,d=e[10].dice+"",l,u,b,h,C,E,A,v,p,c,j,i,z;function f(){return e[8](e[12])}function D(){return e[9](e[12])}return{c(){a=q("li"),o=q("div"),r=q("span"),t=U(s),n=U(" ["),l=U(d),u=U("]"),b=P(),h=q("button"),C=q("img"),A=P(),v=q("button"),p=q("img"),j=P(),m(r,"class","init__text svelte-bhib3l"),X(C.src,E=le)||m(C,"src",E),m(C,"alt","edit user"),m(C,"class","svelte-bhib3l"),m(h,"class","button button--icon button--secondary svelte-bhib3l"),X(p.src,c=pe)||m(p,"src",c),m(p,"alt","remove user"),m(p,"class","svelte-bhib3l"),m(v,"class","button button--icon button--secondary svelte-bhib3l"),m(o,"class","init__content svelte-bhib3l"),m(a,"class","init__item svelte-bhib3l")},m($,B){x($,a,B),g(a,o),g(o,r),g(r,t),g(r,n),g(r,l),g(r,u),g(o,b),g(o,h),g(h,C),g(o,A),g(o,v),g(v,p),g(a,j),i||(z=[N(h,"click",f),N(v,"click",D)],i=!0)},p($,B){e=$,B&4&&s!==(s=e[10].name+"")&&Y(t,s),B&4&&d!==(d=e[10].dice+"")&&Y(l,d)},d($){$&&V(a),i=!1,T(z)}}}function ge(e){let a,o,r,s,t,n,d,l,u,b,h,C,E,A=e[2],v=[];for(let p=0;p<A.length;p+=1)v[p]=Ca(Sa(e,A,p));return{c(){a=q("li"),o=q("form"),r=q("input"),s=P(),t=q("input"),n=P(),d=q("button"),l=q("img"),b=P();for(let p=0;p<v.length;p+=1)v[p].c();h=ma(),m(r,"type","text"),m(r,"class","input svelte-bhib3l"),m(r,"placeholder","Personagem"),m(t,"type","text"),m(t,"class","input input--dice svelte-bhib3l"),m(t,"placeholder","1d20"),X(l.src,u=ce)||m(l,"src",u),m(l,"alt","add user"),m(l,"class","svelte-bhib3l"),m(d,"class","button button--icon svelte-bhib3l"),m(o,"class","init__form svelte-bhib3l"),m(a,"class","init__item svelte-bhib3l")},m(p,c){x(p,a,c),g(a,o),g(o,r),w(r,e[0]),g(o,s),g(o,t),w(t,e[1]),g(o,n),g(o,d),g(d,l),x(p,b,c);for(let j=0;j<v.length;j+=1)v[j].m(p,c);x(p,h,c),C||(E=[N(r,"input",e[6]),N(t,"input",e[7]),N(o,"submit",H(e[3]))],C=!0)},p(p,c){if(c&1&&r.value!==p[0]&&w(r,p[0]),c&2&&t.value!==p[1]&&w(t,p[1]),c&52){A=p[2];let j;for(j=0;j<A.length;j+=1){const i=Sa(p,A,j);v[j]?v[j].p(i,c):(v[j]=Ca(i),v[j].c(),v[j].m(h.parentNode,h))}for(;j<v.length;j+=1)v[j].d(1);v.length=A.length}},d(p){p&&V(a),p&&V(b),Z(v,p),p&&V(h),C=!1,T(E)}}}function ve(e){let a,o;return a=new Ja({props:{className:"init",$$slots:{default:[ge]},$$scope:{ctx:e}}}),{c(){F(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p(r,[s]){const t={};s&8199&&(t.$$scope={dirty:s,ctx:r}),a.$set(t)},i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){M(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}function fe(e,a,o){let r="",s="",t=[];function n(){s===""&&o(1,s="1d20"),o(2,t=[{name:r,dice:s},...t]),o(0,r=""),o(1,s="")}function d(E){o(2,t=t.map((A,v)=>({...A,i:v})).filter(({i:A})=>A!==E))}function l(E){const A=t[E];o(0,r=A.name),o(1,s=A.dice),d(l)}function u(){r=this.value,o(0,r)}function b(){s=this.value,o(1,s)}return[r,s,t,n,d,l,u,b,E=>l(E),E=>d(E)]}class qe extends Q{constructor(a){super(),k(this,a,fe,ve,R,{})}}function he(e){let a,o;return a=new qe({}),{c(){F(a.$$.fragment)},m(r,s){J(a,r,s),o=!0},p:y,i(r){o||(L(a.$$.fragment,r),o=!0)},o(r){M(a.$$.fragment,r),o=!1},d(r){_(a,r)}}}function be(e){return[]}class Ae extends Q{constructor(a){super(),k(this,a,be,he,R,{})}}const je="Classes (SRD)",ze={Sorcerer:{description:`<p>Ao criar um aventureiro feiticeiro, você recebe as seguintes características de classe.</p>
...
<p>14º Nível: <a class="entity-link" draggable="true" data-pack="dnd5e.classfeatures" data-id="EuX1kJNIw1F68yus"><i class="fas fa-suitcase"></i> Santuário Natural</a></p>`,name:"Druida"}},Se={label:je,entries:ze},Ce="Traços raciais (SRD)",Ee={"Savage Attacks":{description:`<p>Quando você atinge um ataque crítico com uma arma corpo-a-corpo, você pode rolar um dos dados de dano da arma mais uma vez e adicioná-lo ao dano extra causado pelo acerto crítico.</p>
<p><em><strong>Foundry Note:</strong> Habilite este recurso na seção de Características Especiais da ficha de personagem.</em></p>`,source:"LdJ pg. 41",name:"Ataques Selvagens"},Dwarf:{description:`<p><em>Um personagem anão possui uma variedade de habilidades inatas, parte integrante da natureza dos anões.</em></p>
...
<p><em><strong>Idiomas.</strong></em> Você pode falar, ler e escrever Comum e Anão. O idioma Anão é repleto de consoantes duras e sons guturais, e essa característica influencia, como um sotaque, qualquer outro idioma que o anão falar.</p>`,source:"LdJ pg. 20",name:"Anão"},Brave:{description:"<p>Você tem vantagem em testes de resistência contra ficar amedrontado.</p>",source:"LdJ pg. 28",name:"Bravura"},"Relentless Endurance":{description:"<p>Quando você é reduzido a 0 pontos de vida mas não é completamente morto, você pode voltar para 1 ponto de vida. Você não pode usar essa característica novamente até completar um descanso longo.</p>",source:"LdJ pg. 41",name:"Resistência Implacável"},"High Elf":{description:`<p><em>Como alto elfo, você possui uma mente afiada e um domínio da magia básico. Em muitos dos mundos de D&D, existem dois tipos de altos elfos. Um tipo são arrogantes e reclusos, acreditando serem superiores aos não elfos e até mesmo a outros elfos. O outro tipo são mais comuns e amigáveis, e muitas vezes encontrados entre humanos e outras raças. </em></p>
...
<p><em><strong>Idioma Adicional.</strong></em> Você pode falar, ler e escrever um idioma adicional à sua escolha.</p>`,source:"LdJ pg. 23",name:"Alto Elfo"},"Gnome Cunning":{description:"<p>Você possui vantagem em todos os testes de resistência de Inteligência, Sabedoria e Carisma contra magia.</p>",source:"LdJ pg. 37",name:"Esperteza Gnômica"},Halfling:{description:`<p><em>Seu halfling possui uma série de características em comum com todos os outros halflings. </em></p>
...
<p><em><strong>Idiomas.</strong></em> Você pode falar, ler e escrever Comum e Halfling. A linguagem Halfling não é secreta, mas os halflings são relutantes em compartilhá-la com os outros. Eles escrevem muito pouco, por isso eles não possuem uma literatura rica. No entanto, sua tradição oral é muito forte. Quase todos os halflings falam o idioma Comum para conversar com as pessoas das terras que habitam, ou através das quais eles estejam viajando.</p>`,source:"LdJ pg. 28",name:"Pequenino"},"Naturally Stealthy":{description:"<p>Você pode tentar se esconder mesmo quando possuir apenas a cobertura de uma criatura que for no mínimo um tamanho maior que o seu.</p>",source:"LdJ pg. 28",name:"Furtividade Natural"},"Half-Elf":{description:`<p><em>Seu personagem meio-elfo possui algumas qualidades em comum com os elfos e algumas são exclusivas dos meio-elfos. </em></p>
...
<p><em><strong>Idiomas. </strong></em>Você pode falar, ler e escrever Comum e Dracônico. O idioma Dracônico é conhecido por ser uma das mais antigas línguas e ainda é usado no estudo de magia. A linguagem soa áspera para a maioria das criaturas, incluindo várias consoantes e silabas firmes.</p>`,source:"LdJ pg. 34",name:"Draconato"},"Breath Weapon":{description:`<p>Você pode usar uma ação para exalar energia destrutiva. Seu ancestral dracônico determina o tamanho, formado e tipo de dano que você expele.</p>
<p>Quando você usa sua arma de sopro, cada criatura na área exalada deve realizar um teste de resistência, o tipo do teste é determinado pelo seu ancestral dracônico. A CD do teste de resistência é 8 + seu modificador de Constituição + seu bônus de proficiência. Uma criatura sofre 2d6 de dano num fracasso e metade desse dano num sucesso. O dano aumenta para 3d6 no 6° nível, 4d6 no 11° nível e 5d6 no 16° nível.</p>
<p>Depois de usar sua arma de sopro, você não poderá utilizá-la novamente até completar um descanso curto ou longo.</p>
<p><em><strong>Foundry Note: </strong>Edite os detalhes para este talento, de modo que o tipo de dano, teste de resistência e área de efeito correspondam aos de seu ancestral Dracônico.</em></p>`,source:"LdJ pg. 34",name:"Arma de Sopro"},Lucky:{description:`<p>Quando você obtiver um 1 natural em uma jogada de ataque, teste de habilidade ou teste de resistência, você pode jogar de novo o dado e deve utilizar o novo resultado.</p>
<p><em><strong>Foundry Note:</strong> Habilite este recurso na seção de Características Especiais da ficha de personagem.</em></p>`,source:"LdJ pg. 28",name:"Sortudo"},"Artificer's Lore":{description:"<p>Toda vez que você fizer um teste de Inteligência (História) relacionado a itens mágicos, objetos alquímicos ou mecanismos tecnológicos, você pode adicionar o dobro do seu bônus de proficiência, ao invés de qualquer bônus de proficiência que você normalmente use.</p>",source:"LdJ pg. 37",name:"Conhecimento de Artífice"},"Halfling Nimbleness":{description:"<p>Você pode mover-se através do espaço de qualquer criatura que for de um tamanho maior que o seu.</p>",source:"LdJ pg. 28",name:"Agilidade Halfling"},"Rock Gnome":{description:`<p><em>Como um gnomo das rochas, você possui uma inventividade e resistência naturais acima dos outros gnomos.</em></p>
...
<p><em><strong>Tenacidade Anã.</strong></em> Seu máximo de pontos de vida aumentam em 1, e cada vez que o anão da colina sobe um nível, ele recebe 1 ponto de vida adicional.</p>`,name:"Anão da Colina"},"Damage Resistance":{description:"<p>Você possui resistência ao tipo de dano associado ao seu ancestral dracônico.</p>",source:"LdJ pg. 34",name:"Resistência a Dano"},"Lightfoot Halfling":{description:`<p><em>Como um halfling pés-leves, você pode esconder-se facilmente, mesmo usando apenas outras pessoas como cobertura. </em></p>
<p><em>Pés-leves são mais propensos à vontade de viajar do que os outros halflings, e muitas vezes vivem ao lado de outras raças ou levam uma vida nômade. </em></p>
<p><em><strong>Aumento no Valor de Habilidade.</strong></em> Seu valor de Carisma aumenta em 1.</p>
<p><strong><em>Furtividade Natural.</em></strong> @Compendium[dnd5e.races.GWPjKFeIthBBeCFJ]{Ilusionista Nato} Você pode tentar se esconder mesmo quando possuir apenas a cobertura de uma criatura que for no mínimo um tamanho maior que o seu.</p>`,source:"LdJ pg. 28",name:"Pés Leves"},Tiefling:{description:`<p><em>Os tieflings compartilham certos traços raciais como resultado de sua descendência infernal. </em></p>
...
<p><em>Brinquedo Mecânico:</em> Esse brinquedo é um animal, monstro ou pessoa mecânica, como um sapo, rato, pássaro, dragão ou soldado. Quando colocado no chão, o brinquedo se move 1,5 metro pelo chão em cada um dos seus turnos em uma direção aleatória. Ele faz barulhos apropriados a criatura que ele representa.</p>
<p><em>Isqueiro Mecânico:</em> O mecanismo produz uma miniatura de chama, que você pode usar para acender uma vela, tocha ou fogueira. Usar o mecanismo requer sua ação.</p>
<p><em>Caixa de Música:</em> Quando aberta, essa caixa de música toca uma canção a um volume moderado. A caixa para de tocar quando alcança o fim da música ou quando é fechada.</p>`,source:"LdJ pg. 37",name:"Engenhoqueiro"},Stonecunning:{description:"<p>Toda vez que você fizer um teste de Inteligência (História) relacionado a itens mágicos, objetos alquímicos ou mecanismos tecnológicos, você pode adicionar o dobro do seu bônus de proficiência, ao invés de qualquer bônus de proficiência que você normalmente use.</p>",source:"LdJ pg. 20",name:"Especialização em Rochas"},"Half-Orc":{description:`<p><em>Seu personagem meio-orc possui certas características derivadas da sua ancestralidade orc. </em></p>
...
<p><em><strong>Idiomas.</strong></em> Você sabe falar, ler e escrever Comum, Orc. O Orc é um idioma ríspido, possuindo uma linguagem de consoantes duras. Ele não possui alfabeto próprio, mas usa o alfabeto Anão.</p>`,source:"LdJ pg. 41",name:"Meio-Orc"},"Hellish Resistance":{description:"<p>Você possui resistência a dano de fogo.</p>",source:"LdJ pg. 43",name:"Resistência Infernal"},Elf:{description:`<p><em>Seu elfo tem uma variedade de habilidades naturais, resultado de milhares de anos de refinamento élfico. </em></p>
<p><em><strong>Aumento no Valor de Habilidade.</strong></em> Seu valor de Destreza aumenta em 2.</p>
...
<p><em><strong>Idiomas.</strong></em> Você pode falar, ler e escrever Comum e Élfico. O Élfico é um idioma fluido, com entonações sutis e gramática complexa. A literatura élfica é rica e diversa, e suas canções e poemas são famosos entre outras raças. Muitos bardos aprendem essa língua para que possam adicionar canções élficas ao seu repertório.</p>`,source:"LdJ pg. 23",name:"Elfo"},"Dwarven Resilience":{description:"<p>Você possui vantagem em testes de resistência contra venenos e resistência contra dano de veneno.</p>",source:"LdJ pg. 20",name:"Resiliência Anã"},"Infernal Legacy":{description:`<p>Você conhece o truque @Compendium[dnd5e.spells.MUO1uYN7JR1hm4dR]{Taumaturgia}.</p>
<p>Quando você atingir o 3° nível, você poderá conjurar a magia @Compendium[dnd5e.spells.22dPoeXfaaAv4K3h]{Repreensão Infernal} como uma magia de 2° nível. Você precisa terminar um descanso longo para poder usar as magias desse traço novamente.</p>
<p>Quando você atingir o 5° nível, você também poderá conjurar a magia @Compendium[dnd5e.spells.S7VbUetIfVT7B6Eq]{Escuridão}. Você precisa terminar um descanso longo para poder usar as magias desse traço novamente. Sua habilidade de conjuração para essas magias é Carisma.</p>`,source:"LdJ pg. 43",name:"Legado Infernal"},Human:{description:`<p><em>É difícil fazer generalizações sobre os humanos, mas seu humano possui as seguintes características. </em></p>
...
<p><em><strong>Deslocamento.</strong></em> Seu deslocamento base de caminhada é 9 metros.</p>
<p><em><strong>Idiomas. </strong></em>Você pode falar, ler e escrever Comum e outro idioma adicional, à sua escolha. Os humanos normalmente aprendem os idiomas dos povos que convivem, incluindo dialetos obscuros. Eles gostam de rechear seu discurso com palavras emprestadas de outras línguas: xingamentos orcs, expressões musicais élficas, frases militares anãs e outros.</p>`,source:"LdJ pg. 31",name:"Humano"}},Ve={source:"data.source",range:{path:"data.range",converter:"range"},target:{path:"data.target",converter:"target"}},xe={label:Ce,entries:Ee,mapping:Ve},Pe="Magias (SRD)",Le={Polymorph:{description:`<p>A magia transforma uma criatura à sua vista, no alcance da magia, em uma nova forma. Uma criatura não voluntária deve fazer uma salvaguarda de Sabedoria para evitar o efeito. A magia não tem efeito sobre um Metamorfo ou em uma criatura com 0 pontos de vida.</p>
...
<p>O cravo ou cravo-da-índia (Syzygium aromaticum), é uma árvore perene da família da murta, eles são secos e possuem botão fechado.</p>`,source:"LdJ pg. 157",name:"Cravo"}},_e={source:"data.source",weight:{path:"data.weight",converter:"weight"}},Fe={label:Oe,entries:Je,mapping:_e};function Ue(e){let a;return{c(){a=U("Iniciativa")},m(o,r){x(o,a,r)},d(o){o&&V(a)}}}function Ne(e){let a,o,r,s,t,n,d,l,u,b,h,C,E,A,v,p,c,j,i,z,f,D;o=new Ka({props:{$$slots:{default:[Ue]},$$scope:{ctx:e}}});function $(S){e[2](S)}let B={items:e[1]};return e[0]!==void 0&&(B.value=e[0]),s=new Ya({props:B}),na.push(()=>Ba(s,"value",$,e[0])),u=new Ae({}),C=new oa({props:{data:Se,label:"Classes"}}),v=new oa({props:{data:xe,label:"Raças"}}),j=new oa({props:{data:Me,label:"Magias"}}),f=new oa({props:{data:Fe,label:"Comércio"}}),{c(){a=q("div"),F(o.$$.fragment),r=P(),F(s.$$.fragment),n=P(),d=q("div"),l=q("div"),F(u.$$.fragment),b=P(),h=q("div"),F(C.$$.fragment),E=P(),A=q("div"),F(v.$$.fragment),p=P(),c=q("div"),F(j.$$.fragment),i=P(),z=q("div"),F(f.$$.fragment),m(l,"class","item svelte-18gp8wx"),O(l,"active",e[0]==="/iniciativa"),m(h,"class","item svelte-18gp8wx"),O(h,"active",e[0]==="/classes"),m(A,"class","item svelte-18gp8wx"),O(A,"active",e[0]==="/racas"),m(c,"class","item svelte-18gp8wx"),O(c,"active",e[0]==="/magias"),m(z,"class","item svelte-18gp8wx"),O(z,"active",e[0]==="/tradegoods"),m(d,"class","content svelte-18gp8wx"),m(a,"class","page svelte-18gp8wx")},m(S,I){x(S,a,I),J(o,a,null),g(a,r),J(s,a,null),g(a,n),g(a,d),g(d,l),J(u,l,null),g(d,b),g(d,h),J(C,h,null),g(d,E),g(d,A),J(v,A,null),g(d,p),g(d,c),J(j,c,null),g(d,i),g(d,z),J(f,z,null),D=!0},p(S,[I]){const pa={};I&8&&(pa.$$scope={dirty:I,ctx:S}),o.$set(pa);const la={};!t&&I&1&&(t=!0,la.value=S[0],Ra(()=>t=!1)),s.$set(la),(!D||I&1)&&O(l,"active",S[0]==="/iniciativa"),(!D||I&1)&&O(h,"active",S[0]==="/classes"),(!D||I&1)&&O(A,"active",S[0]==="/racas"),(!D||I&1)&&O(c,"active",S[0]==="/magias"),(!D||I&1)&&O(z,"active",S[0]==="/tradegoods")},i(S){D||(L(o.$$.fragment,S),L(s.$$.fragment,S),L(u.$$.fragment,S),L(C.$$.fragment,S),L(v.$$.fragment,S),L(j.$$.fragment,S),L(f.$$.fragment,S),D=!0)},o(S){M(o.$$.fragment,S),M(s.$$.fragment,S),M(u.$$.fragment,S),M(C.$$.fragment,S),M(v.$$.fragment,S),M(j.$$.fragment,S),M(f.$$.fragment,S),D=!1},d(S){S&&V(a),_(o),_(s),_(u),_(C),_(v),_(j),_(f)}}}function Ie(e,a,o){let r="/iniciativa";const s=[{slug:"/iniciativa",label:"Iniciativa"},{slug:"/classes",label:"Classes"},{slug:"/racas",label:"Raças"},{slug:"/magias",label:"Magias"},{slug:"/tradegoods",label:"Comércio"}];function t(n){r=n,o(0,r)}return[r,s,t]}class ye extends Q{constructor(a){super(),k(this,a,Ie,Ne,R,{})}}function Te(e){let a,o,r;return o=new ye({}),{c(){a=q("main"),F(o.$$.fragment)},m(s,t){x(s,a,t),J(o,a,null),r=!0},p:y,i(s){r||(L(o.$$.fragment,s),r=!0)},o(s){M(o.$$.fragment,s),r=!1},d(s){s&&V(a),_(o)}}}class Re extends Q{constructor(a){super(),k(this,a,null,Te,R,{})}}new Re({target:document.getElementById("app")});
