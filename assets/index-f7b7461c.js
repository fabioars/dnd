(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerpolicy&&(t.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?t.credentials="include":s.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(s){if(s.ep)return;s.ep=!0;const t=o(s);fetch(s.href,t)}})();function T(){}function Ia(a,e){for(const o in e)a[o]=e[o];return a}function Da(a){return a()}function fa(){return Object.create(null)}function k(a){a.forEach(Da)}function La(a){return typeof a=="function"}function Q(a,e){return a!=a?e==e:a!==e||a&&typeof a=="object"||typeof a=="function"}let ea;function da(a,e){return ea||(ea=document.createElement("a")),ea.href=e,a===ea.href}function ya(a){return Object.keys(a).length===0}function Ma(a,e,o,r){if(a){const s=Oa(a,e,o,r);return a[0](s)}}function Oa(a,e,o,r){return a[1]&&r?Ia(o.ctx.slice(),a[1](r(e))):o.ctx}function Ja(a,e,o,r){if(a[2]&&r){const s=a[2](r(o));if(e.dirty===void 0)return s;if(typeof s=="object"){const t=[],n=Math.max(e.dirty.length,s.length);for(let d=0;d<n;d+=1)t[d]=e.dirty[d]|s[d];return t}return e.dirty|s}return e.dirty}function _a(a,e,o,r,s,t){if(s){const n=Oa(e,o,r,t);a.p(n,s)}}function Ua(a){if(a.ctx.length>32){const e=[],o=a.ctx.length/32;for(let r=0;r<o;r++)e[r]=-1;return e}return-1}function g(a,e){a.appendChild(e)}function P(a,e,o){a.insertBefore(e,o||null)}function x(a){a.parentNode&&a.parentNode.removeChild(a)}function aa(a,e){for(let o=0;o<a.length;o+=1)a[o]&&a[o].d(e)}function q(a){return document.createElement(a)}function Ta(a){return document.createElementNS("http://www.w3.org/2000/svg",a)}function W(a){return document.createTextNode(a)}function V(){return W(" ")}function ga(){return W("")}function M(a,e,o,r){return a.addEventListener(e,o,r),()=>a.removeEventListener(e,o,r)}function H(a){return function(e){return e.preventDefault(),a.call(this,e)}}function i(a,e,o){o==null?a.removeAttribute(e):a.getAttribute(e)!==o&&a.setAttribute(e,o)}function R(a){return a===""?null:+a}function Ra(a){return Array.from(a.childNodes)}function ia(a,e){e=""+e,a.wholeText!==e&&(a.data=e)}function L(a,e){a.value=e??""}function _(a,e,o){a.classList[o?"add":"remove"](e)}class ka{constructor(e=!1){this.is_svg=!1,this.is_svg=e,this.e=this.n=null}c(e){this.h(e)}m(e,o,r=null){this.e||(this.is_svg?this.e=Ta(o.nodeName):this.e=q(o.nodeName),this.t=o,this.c(e)),this.i(r)}h(e){this.e.innerHTML=e,this.n=Array.from(this.e.childNodes)}i(e){for(let o=0;o<this.n.length;o+=1)P(this.t,this.n[o],e)}p(e){this.d(),this.h(e),this.i(this.a)}d(){this.n.forEach(x)}}let va;function Y(a){va=a}const Z=[],ma=[],sa=[],ca=[],Qa=Promise.resolve();let pa=!1;function Ba(){pa||(pa=!0,Qa.then(Fa))}function la(a){sa.push(a)}function Ga(a){ca.push(a)}const ua=new Set;let oa=0;function Fa(){const a=va;do{for(;oa<Z.length;){const e=Z[oa];oa++,Y(e),$a(e.$$)}for(Y(null),Z.length=0,oa=0;ma.length;)ma.pop()();for(let e=0;e<sa.length;e+=1){const o=sa[e];ua.has(o)||(ua.add(o),o())}sa.length=0}while(Z.length);for(;ca.length;)ca.pop()();pa=!1,ua.clear(),Y(a)}function $a(a){if(a.fragment!==null){a.update(),k(a.before_update);const e=a.dirty;a.dirty=[-1],a.fragment&&a.fragment.p(a.ctx,e),a.after_update.forEach(la)}}const ta=new Set;let w;function wa(){w={r:0,c:[],p:w}}function Ha(){w.r||k(w.c),w=w.p}function O(a,e){a&&a.i&&(ta.delete(a),a.i(e))}function J(a,e,o,r){if(a&&a.o){if(ta.has(a))return;ta.add(a),w.c.push(()=>{ta.delete(a),r&&(o&&a.d(1),r())}),a.o(e)}else r&&r()}function Wa(a,e,o,r){const s=a.$$.props[e];s!==void 0&&(a.$$.bound[s]=o,r===void 0&&o(a.$$.ctx[s]))}function I(a){a&&a.c()}function U(a,e,o,r){const{fragment:s,after_update:t}=a.$$;s&&s.m(e,o),r||la(()=>{const n=a.$$.on_mount.map(Da).filter(La);a.$$.on_destroy?a.$$.on_destroy.push(...n):k(n),a.$$.on_mount=[]}),t.forEach(la)}function F(a,e){const o=a.$$;o.fragment!==null&&(k(o.on_destroy),o.fragment&&o.fragment.d(e),o.on_destroy=o.fragment=null,o.ctx=[])}function Ka(a,e){a.$$.dirty[0]===-1&&(Z.push(a),Ba(),a.$$.dirty.fill(0)),a.$$.dirty[e/31|0]|=1<<e%31}function B(a,e,o,r,s,t,n,d=[-1]){const v=va;Y(a);const u=a.$$={fragment:null,ctx:[],props:t,update:T,not_equal:s,bound:fa(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(v?v.$$.context:[])),callbacks:fa(),dirty:d,skip_bound:!1,root:e.target||v.$$.root};n&&n(u.root);let f=!1;if(u.ctx=o?o(a,e.props||{},(h,A,...D)=>{const C=D.length?D[0]:A;return u.ctx&&s(u.ctx[h],u.ctx[h]=C)&&(!u.skip_bound&&u.bound[h]&&u.bound[h](C),f&&Ka(a,h)),A}):[],u.update(),f=!0,k(u.before_update),u.fragment=r?r(u.ctx):!1,e.target){if(e.hydrate){const h=Ra(e.target);u.fragment&&u.fragment.l(h),h.forEach(x)}else u.fragment&&u.fragment.c();e.intro&&O(a.$$.fragment),U(a,e.target,e.anchor,e.customElement),Fa()}Y(v)}class G{$destroy(){F(this,1),this.$destroy=T}$on(e,o){if(!La(o))return T;const r=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return r.push(o),()=>{const s=r.indexOf(o);s!==-1&&r.splice(s,1)}}$set(e){this.$$set&&!ya(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function Xa(a){let e;return{c(){e=W("Hello World")},m(o,r){P(o,e,r)},d(o){o&&x(e)}}}function Za(a){let e,o,r,s;const t=a[1].default,n=Ma(t,a,a[0],null),d=n||Xa();return{c(){e=q("header"),o=q("div"),r=q("h1"),d&&d.c(),i(r,"class","header__title svelte-liwc8f"),i(o,"class","header__container svelte-liwc8f"),i(e,"class","header svelte-liwc8f")},m(v,u){P(v,e,u),g(e,o),g(o,r),d&&d.m(r,null),s=!0},p(v,[u]){n&&n.p&&(!s||u&1)&&_a(n,t,v,v[0],s?Ja(t,v[0],u,null):Ua(v[0]),null)},i(v){s||(O(d,v),s=!0)},o(v){J(d,v),s=!1},d(v){v&&x(e),d&&d.d(v)}}}function Ya(a,e,o){let{$$slots:r={},$$scope:s}=e;return a.$$set=t=>{"$$scope"in t&&o(0,s=t.$$scope)},[s,r]}class ae extends G{constructor(e){super(),B(this,e,Ya,Za,Q,{})}}function qa(a,e,o){const r=a.slice();return r[3]=e[o],r}function ha(a){let e,o,r=a[3].label+"",s,t,n,d;function v(){return a[2](a[3])}return{c(){e=q("li"),o=q("a"),s=W(r),t=V(),i(o,"href","#"),i(o,"class","nav__link svelte-1n62zsf"),i(e,"class","nav__item svelte-1n62zsf"),_(e,"nav__item--active",a[3].slug==a[0])},m(u,f){P(u,e,f),g(e,o),g(o,s),g(e,t),n||(d=M(o,"click",H(v)),n=!0)},p(u,f){a=u,f&2&&r!==(r=a[3].label+"")&&ia(s,r),f&3&&_(e,"nav__item--active",a[3].slug==a[0])},d(u){u&&x(e),n=!1,d()}}}function ee(a){let e,o,r=a[1],s=[];for(let t=0;t<r.length;t+=1)s[t]=ha(qa(a,r,t));return{c(){e=q("nav"),o=q("ul");for(let t=0;t<s.length;t+=1)s[t].c();i(o,"class","nav__list svelte-1n62zsf"),i(e,"class","nav svelte-1n62zsf")},m(t,n){P(t,e,n),g(e,o);for(let d=0;d<s.length;d+=1)s[d].m(o,null)},p(t,[n]){if(n&3){r=t[1];let d;for(d=0;d<r.length;d+=1){const v=qa(t,r,d);s[d]?s[d].p(v,n):(s[d]=ha(v),s[d].c(),s[d].m(o,null))}for(;d<s.length;d+=1)s[d].d(1);s.length=r.length}},i:T,o:T,d(t){t&&x(e),aa(s,t)}}}function oe(a,e,o){let{value:r}=e,{items:s}=e;const t=n=>o(0,r=n.slug);return a.$$set=n=>{"value"in n&&o(0,r=n.value),"items"in n&&o(1,s=n.items)},[r,s,t]}class re extends G{constructor(e){super(),B(this,e,oe,ee,Q,{value:0,items:1})}}function se(a){let e,o,r;const s=a[2].default,t=Ma(s,a,a[1],null);return{c(){e=q("ul"),t&&t.c(),i(e,"class",o="list "+a[0]+" svelte-t0otg3")},m(n,d){P(n,e,d),t&&t.m(e,null),r=!0},p(n,[d]){t&&t.p&&(!r||d&2)&&_a(t,s,n,n[1],r?Ja(s,n[1],d,null):Ua(n[1]),null),(!r||d&1&&o!==(o="list "+n[0]+" svelte-t0otg3"))&&i(e,"class",o)},i(n){r||(O(t,n),r=!0)},o(n){J(t,n),r=!1},d(n){n&&x(e),t&&t.d(n)}}}function te(a,e,o){let{$$slots:r={},$$scope:s}=e,{className:t=""}=e;return a.$$set=n=>{"className"in n&&o(0,t=n.className),"$$scope"in n&&o(1,s=n.$$scope)},[t,s,r]}class Na extends G{constructor(e){super(),B(this,e,te,se,Q,{className:0})}}const ne="/dnd/assets/x-25909307.svg";function ba(a,e,o){const r=a.slice();return r[2]=e[o],r}function Aa(a){let e,o=a[0][a[2]]+"",r;return{c(){e=new ka(!1),r=ga(),e.a=r},m(s,t){e.m(o,s,t),P(s,r,t)},p(s,t){t&1&&o!==(o=s[0][s[2]]+"")&&e.p(o)},d(s){s&&x(r),s&&e.d()}}}function de(a){let e,o,r,s,t,n,d,v,u,f=a[0].name+"",h,A,D,C,b=Object.keys(a[0]),z=[];for(let l=0;l<b.length;l+=1)z[l]=Aa(ba(a,b,l));return{c(){e=q("div"),o=q("div"),r=V(),s=q("div"),t=q("button"),n=q("img"),v=V(),u=q("h2"),h=W(f),A=V();for(let l=0;l<z.length;l+=1)z[l].c();i(o,"class","overlay svelte-1wu5zh3"),da(n.src,d=ne)||i(n,"src",d),i(n,"alt","close"),i(t,"class","close svelte-1wu5zh3"),i(u,"class","title svelte-1wu5zh3"),i(s,"class","container svelte-1wu5zh3"),i(e,"class","modal svelte-1wu5zh3"),_(e,"active",a[0].isActive)},m(l,E){P(l,e,E),g(e,o),g(e,r),g(e,s),g(s,t),g(t,n),g(s,v),g(s,u),g(u,h),g(s,A);for(let m=0;m<z.length;m+=1)z[m].m(s,null);D||(C=[M(o,"click",H(a[1])),M(t,"click",H(a[1]))],D=!0)},p(l,[E]){if(E&1&&f!==(f=l[0].name+"")&&ia(h,f),E&1){b=Object.keys(l[0]);let m;for(m=0;m<b.length;m+=1){const c=ba(l,b,m);z[m]?z[m].p(c,E):(z[m]=Aa(c),z[m].c(),z[m].m(s,null))}for(;m<z.length;m+=1)z[m].d(1);z.length=b.length}E&1&&_(e,"active",l[0].isActive)},i:T,o:T,d(l){l&&x(e),aa(z,l),D=!1,k(C)}}}function ie(a,e,o){let{entry:r}=e;function s(){o(0,r.isActive=!1,r)}return a.$$set=t=>{"entry"in t&&o(0,r=t.entry)},[r,s]}class ue extends G{constructor(e){super(),B(this,e,ie,de,Q,{entry:0})}}const me="/dnd/assets/search-3252ceb1.svg";function ja(a,e,o){const r=a.slice();return r[6]=e[o],r}function za(a,e,o){const r=a.slice();return r[6]=e[o],r[9]=e,r[10]=o,r}function Sa(a){let e,o,r,s=a[6].name+"",t,n,d;function v(){return a[5](a[6],a[9],a[10])}return{c(){e=q("li"),o=q("a"),r=q("span"),t=W(s),i(r,"class","init__text"),i(o,"href","#"),i(o,"class","init__content svelte-12ax5ri"),i(e,"class","init__item svelte-12ax5ri")},m(u,f){P(u,e,f),g(e,o),g(o,r),g(r,t),n||(d=M(o,"click",H(v)),n=!0)},p(u,f){a=u,f&4&&s!==(s=a[6].name+"")&&ia(t,s)},d(u){u&&x(e),n=!1,d()}}}function Ca(a){let e,o;return e=new ue({props:{entry:a[6]}}),{c(){I(e.$$.fragment)},m(r,s){U(e,r,s),o=!0},p(r,s){const t={};s&4&&(t.entry=r[6]),e.$set(t)},i(r){o||(O(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){F(e,r)}}}function ce(a){let e,o,r,s,t,n,d,v,u,f,h,A,D,C=a[2],b=[];for(let m=0;m<C.length;m+=1)b[m]=Sa(za(a,C,m));let z=a[2],l=[];for(let m=0;m<z.length;m+=1)l[m]=Ca(ja(a,z,m));const E=m=>J(l[m],1,1,()=>{l[m]=null});return{c(){e=q("li"),o=q("form"),r=q("input"),s=V(),t=q("button"),n=q("img"),v=V();for(let m=0;m<b.length;m+=1)b[m].c();u=V();for(let m=0;m<l.length;m+=1)l[m].c();f=ga(),i(r,"type","search"),i(r,"class","input svelte-12ax5ri"),i(r,"placeholder",a[0]),da(n.src,d=me)||i(n,"src",d),i(n,"alt","add user"),i(n,"class","svelte-12ax5ri"),i(t,"class","button button--icon svelte-12ax5ri"),t.disabled=!0,i(o,"class","init__form svelte-12ax5ri"),i(e,"class","init__item svelte-12ax5ri")},m(m,c){P(m,e,c),g(e,o),g(o,r),L(r,a[1]),g(o,s),g(o,t),g(t,n),P(m,v,c);for(let p=0;p<b.length;p+=1)b[p].m(m,c);P(m,u,c);for(let p=0;p<l.length;p+=1)l[p].m(m,c);P(m,f,c),h=!0,A||(D=[M(r,"input",a[4]),M(o,"submit",H(le))],A=!0)},p(m,c){if((!h||c&1)&&i(r,"placeholder",m[0]),c&2&&L(r,m[1]),c&4){C=m[2];let p;for(p=0;p<C.length;p+=1){const j=za(m,C,p);b[p]?b[p].p(j,c):(b[p]=Sa(j),b[p].c(),b[p].m(u.parentNode,u))}for(;p<b.length;p+=1)b[p].d(1);b.length=C.length}if(c&4){z=m[2];let p;for(p=0;p<z.length;p+=1){const j=ja(m,z,p);l[p]?(l[p].p(j,c),O(l[p],1)):(l[p]=Ca(j),l[p].c(),O(l[p],1),l[p].m(f.parentNode,f))}for(wa(),p=z.length;p<l.length;p+=1)E(p);Ha()}},i(m){if(!h){for(let c=0;c<z.length;c+=1)O(l[c]);h=!0}},o(m){l=l.filter(Boolean);for(let c=0;c<l.length;c+=1)J(l[c]);h=!1},d(m){m&&x(e),m&&x(v),aa(b,m),m&&x(u),aa(l,m),m&&x(f),A=!1,k(D)}}}function pe(a){let e,o;return e=new Na({props:{className:"db",$$slots:{default:[ce]},$$scope:{ctx:a}}}),{c(){I(e.$$.fragment)},m(r,s){U(e,r,s),o=!0},p(r,[s]){const t={};s&2055&&(t.$$scope={dirty:s,ctx:r}),e.$set(t)},i(r){o||(O(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){F(e,r)}}}const le=()=>{};function ge(a,e,o){let r,{data:s}=e,{label:t}=e,n="";function d(){n=this.value,o(1,n)}const v=(u,f,h)=>o(2,f[h].isActive=!0,r);return a.$$set=u=>{"data"in u&&o(3,s=u.data),"label"in u&&o(0,t=u.label)},a.$$.update=()=>{a.$$.dirty&10&&o(2,r=Object.keys(s.entries).map(u=>({...s.entries[u],isModalOpen:!1})).filter(u=>u.name.toLowerCase().includes(n.toLowerCase())))},[t,n,r,s,d,v]}class ra extends G{constructor(e){super(),B(this,e,ge,pe,Q,{data:3,label:0})}}const ve="/dnd/assets/user-plus-3c6aeeff.svg",fe="/dnd/assets/user-minus-e4725f11.svg";function Ea(a,e,o){const r=a.slice();return r[18]=e[o],r[19]=e,r[20]=o,r}function Va(a){let e,o,r,s,t,n,d,v,u,f,h,A,D,C,b,z,l,E,m,c;function p(){a[11].call(r,a[19],a[20])}function j(){a[12].call(t,a[19],a[20])}function K(){return a[13](a[20])}function X(){a[14].call(A,a[19],a[20])}function S(){a[15].call(b,a[19],a[20])}function N(){a[16].call(l,a[19],a[20])}return{c(){e=q("li"),o=q("form"),r=q("input"),s=V(),t=q("input"),n=V(),d=q("button"),v=q("img"),f=V(),h=q("div"),A=q("input"),C=V(),b=q("input"),z=V(),l=q("input"),E=V(),i(r,"type","text"),i(r,"class","input input--clear svelte-tytoh0"),i(r,"placeholder","Personagem"),i(t,"type","text"),i(t,"class","input input--clear input--dice svelte-tytoh0"),i(t,"placeholder","1d20"),da(v.src,u=fe)||i(v,"src",u),i(v,"alt","remove user"),i(v,"class","svelte-tytoh0"),i(d,"class","button button--icon button--secondary svelte-tytoh0"),i(d,"type","button"),i(o,"class","init__form svelte-tytoh0"),i(A,"type","range"),i(A,"name","HP"),i(A,"min","0"),i(A,"max",D=a[18].maxHp),i(A,"id","hp"),i(b,"type","number"),i(b,"class","input input--clear svelte-tytoh0"),i(b,"placeholder","HP"),i(l,"type","number"),i(l,"class","input input--clear svelte-tytoh0"),i(l,"placeholder","Max HP"),i(h,"class","hp svelte-tytoh0"),i(e,"class","init__item svelte-tytoh0")},m($,y){P($,e,y),g(e,o),g(o,r),L(r,a[18].name),g(o,s),g(o,t),L(t,a[18].dice),g(o,n),g(o,d),g(d,v),g(e,f),g(e,h),g(h,A),L(A,a[18].hp),g(h,C),g(h,b),L(b,a[18].hp),g(h,z),g(h,l),L(l,a[18].maxHp),g(e,E),m||(c=[M(r,"input",p),M(t,"input",j),M(d,"click",K),M(o,"submit",H(Ae)),M(A,"change",X),M(A,"input",X),M(b,"input",S),M(l,"input",N)],m=!0)},p($,y){a=$,y&1&&r.value!==a[18].name&&L(r,a[18].name),y&1&&t.value!==a[18].dice&&L(t,a[18].dice),y&1&&D!==(D=a[18].maxHp)&&i(A,"max",D),y&1&&L(A,a[18].hp),y&1&&R(b.value)!==a[18].hp&&L(b,a[18].hp),y&1&&R(l.value)!==a[18].maxHp&&L(l,a[18].maxHp)},d($){$&&x(e),m=!1,k(c)}}}function qe(a){let e,o,r,s,t,n,d,v,u,f,h,A,D,C,b,z,l,E=a[0],m=[];for(let c=0;c<E.length;c+=1)m[c]=Va(Ea(a,E,c));return{c(){e=q("li"),o=q("form"),r=q("input"),s=V(),t=q("input"),n=V(),d=q("input"),v=V(),u=q("input"),f=V(),h=q("button"),A=q("img"),C=V();for(let c=0;c<m.length;c+=1)m[c].c();b=ga(),i(r,"type","text"),i(r,"class","input svelte-tytoh0"),i(r,"placeholder","Personagem"),i(t,"type","text"),i(t,"class","input input--dice svelte-tytoh0"),i(t,"placeholder","1d20"),i(d,"type","number"),i(d,"min","0"),i(d,"class","input input--dice svelte-tytoh0"),i(d,"placeholder","HP"),i(u,"type","number"),i(u,"min","0"),i(u,"class","input input--dice svelte-tytoh0"),i(u,"placeholder","Max HP"),da(A.src,D=ve)||i(A,"src",D),i(A,"alt","add user"),i(A,"class","svelte-tytoh0"),i(h,"class","button button--icon svelte-tytoh0"),i(o,"class","init__form svelte-tytoh0"),i(e,"class","init__item svelte-tytoh0")},m(c,p){P(c,e,p),g(e,o),g(o,r),L(r,a[1]),g(o,s),g(o,t),L(t,a[2]),g(o,n),g(o,d),L(d,a[3]),g(o,v),g(o,u),L(u,a[4]),g(o,f),g(o,h),g(h,A),P(c,C,p);for(let j=0;j<m.length;j+=1)m[j].m(c,p);P(c,b,p),z||(l=[M(r,"input",a[7]),M(t,"input",a[8]),M(d,"input",a[9]),M(u,"input",a[10]),M(o,"submit",H(a[5]))],z=!0)},p(c,p){if(p&2&&r.value!==c[1]&&L(r,c[1]),p&4&&t.value!==c[2]&&L(t,c[2]),p&8&&R(d.value)!==c[3]&&L(d,c[3]),p&16&&R(u.value)!==c[4]&&L(u,c[4]),p&65){E=c[0];let j;for(j=0;j<E.length;j+=1){const K=Ea(c,E,j);m[j]?m[j].p(K,p):(m[j]=Va(K),m[j].c(),m[j].m(b.parentNode,b))}for(;j<m.length;j+=1)m[j].d(1);m.length=E.length}},d(c){c&&x(e),c&&x(C),aa(m,c),c&&x(b),z=!1,k(l)}}}function he(a){let e,o;return e=new Na({props:{className:"init",$$slots:{default:[qe]},$$scope:{ctx:a}}}),{c(){I(e.$$.fragment)},m(r,s){U(e,r,s),o=!0},p(r,[s]){const t={};s&2097183&&(t.$$scope={dirty:s,ctx:r}),e.$set(t)},i(r){o||(O(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){F(e,r)}}}const xa=50,be="1d20",Ae=()=>{};function je(a,e,o){let{chars:r}=e,s="",t="",n,d;function v(){t===""&&o(2,t=be),o(0,r=[{name:s,dice:t,maxHp:d||xa,hp:n||xa},...r]),o(1,s=""),o(2,t="")}function u(c){o(0,r=r.map((p,j)=>({...p,i:j})).filter(({i:p})=>p!==c))}function f(){s=this.value,o(1,s)}function h(){t=this.value,o(2,t)}function A(){n=R(this.value),o(3,n)}function D(){d=R(this.value),o(4,d)}function C(c,p){c[p].name=this.value,o(0,r)}function b(c,p){c[p].dice=this.value,o(0,r)}const z=c=>u(c);function l(c,p){c[p].hp=R(this.value),o(0,r)}function E(c,p){c[p].hp=R(this.value),o(0,r)}function m(c,p){c[p].maxHp=R(this.value),o(0,r)}return a.$$set=c=>{"chars"in c&&o(0,r=c.chars)},[r,s,t,n,d,v,u,f,h,A,D,C,b,z,l,E,m]}class ze extends G{constructor(e){super(),B(this,e,je,he,Q,{chars:0})}}function Se(a){let e,o;return e=new ze({props:{chars:a[0]}}),{c(){I(e.$$.fragment)},m(r,s){U(e,r,s),o=!0},p(r,s){const t={};s&1&&(t.chars=r[0]),e.$set(t)},i(r){o||(O(e.$$.fragment,r),o=!0)},o(r){J(e.$$.fragment,r),o=!1},d(r){F(e,r)}}}function Ce(a){return{c:T,m:T,d:T}}function Ee(a){let e;return{c(){e=q("div"),i(e,"class","create")},m(o,r){P(o,e,r)},d(o){o&&x(e)}}}function Ve(a){let e;return{c(){e=q("div"),i(e,"class","run")},m(o,r){P(o,e,r)},d(o){o&&x(e)}}}function xe(a){let e,o,r,s,t,n=a[1]===na&&Se(a),d=a[1]===Pa&&Ce(),v=a[1]===na&&Ee(),u=a[1]===Pa&&Ve();return{c(){n&&n.c(),e=V(),d&&d.c(),o=V(),r=q("div"),v&&v.c(),s=V(),u&&u.c(),i(r,"class","control")},m(f,h){n&&n.m(f,h),P(f,e,h),d&&d.m(f,h),P(f,o,h),P(f,r,h),v&&v.m(r,null),g(r,s),u&&u.m(r,null),t=!0},p(f,[h]){f[1]===na&&n.p(f,h)},i(f){t||(O(n),t=!0)},o(f){J(n),t=!1},d(f){n&&n.d(f),f&&x(e),d&&d.d(f),f&&x(o),f&&x(r),v&&v.d(),u&&u.d()}}}const na="create",Pa="run";function Pe(a,e,o){let{chars:r=[]}=e,{turn:s=[]}=e,t=na;return a.$$set=n=>{"chars"in n&&o(0,r=n.chars),"turn"in n&&o(2,s=n.turn)},[r,t,s]}class De extends G{constructor(e){super(),B(this,e,Pe,xe,Q,{chars:0,turn:2})}}const Le="Classes (SRD)",Me={Sorcerer:{description:`<p>Ao criar um aventureiro feiticeiro, você recebe as seguintes características de classe.</p>
...
<p>14º Nível: <a class="entity-link" draggable="true" data-pack="dnd5e.classfeatures" data-id="EuX1kJNIw1F68yus"><i class="fas fa-suitcase"></i> Santuário Natural</a></p>`,name:"Druida"}},Oe={label:Le,entries:Me},Je="Traços raciais (SRD)",_e={Dwarf:{description:`<p><em>Um personagem anão possui uma variedade de habilidades inatas, parte integrante da natureza dos anões.</em></p>
...
<p><em><strong>Deslocamento.</strong></em> Seu deslocamento base de caminhada é 9 metros.</p>
<p><em><strong>Idiomas. </strong></em>Você pode falar, ler e escrever Comum e outro idioma adicional, à sua escolha. Os humanos normalmente aprendem os idiomas dos povos que convivem, incluindo dialetos obscuros. Eles gostam de rechear seu discurso com palavras emprestadas de outras línguas: xingamentos orcs, expressões musicais élficas, frases militares anãs e outros.</p>`,source:"LdJ pg. 31",name:"Humano"}},Ue={source:"data.source",range:{path:"data.range",converter:"range"},target:{path:"data.target",converter:"target"}},Fe={label:Je,entries:_e,mapping:Ue},Ne="Magias (SRD)",Ie={Polymorph:{description:`<p>A magia transforma uma criatura à sua vista, no alcance da magia, em uma nova forma. Uma criatura não voluntária deve fazer uma salvaguarda de Sabedoria para evitar o efeito. A magia não tem efeito sobre um Metamorfo ou em uma criatura com 0 pontos de vida.</p>
...
<p>O cravo ou cravo-da-índia (Syzygium aromaticum), é uma árvore perene da família da murta, eles são secos e possuem botão fechado.</p>`,source:"LdJ pg. 157",name:"Cravo"}},Qe={source:"data.source",weight:{path:"data.weight",converter:"weight"}},Be={label:Re,entries:ke,mapping:Qe};function Ge(a){let e=a[1].find(a[2]).label+"",o;return{c(){o=W(e)},m(r,s){P(r,o,s)},p(r,s){s&1&&e!==(e=r[1].find(r[2]).label+"")&&ia(o,e)},d(r){r&&x(o)}}}function $e(a){let e,o,r,s,t,n,d,v,u,f,h,A,D,C,b,z,l,E,m,c,p,j;o=new ae({props:{$$slots:{default:[Ge]},$$scope:{ctx:a}}});function K(S){a[3](S)}let X={items:a[1]};return a[0]!==void 0&&(X.value=a[0]),s=new re({props:X}),ma.push(()=>Wa(s,"value",K,a[0])),u=new De({}),A=new ra({props:{data:Oe,label:"Classes"}}),b=new ra({props:{data:Fe,label:"Raças"}}),E=new ra({props:{data:Te,label:"Magias"}}),p=new ra({props:{data:Be,label:"Comércio"}}),{c(){e=q("div"),I(o.$$.fragment),r=V(),I(s.$$.fragment),n=V(),d=q("div"),v=q("div"),I(u.$$.fragment),f=V(),h=q("div"),I(A.$$.fragment),D=V(),C=q("div"),I(b.$$.fragment),z=V(),l=q("div"),I(E.$$.fragment),m=V(),c=q("div"),I(p.$$.fragment),i(v,"class","item svelte-18gp8wx"),_(v,"active",a[0]==="/iniciativa"),i(h,"class","item svelte-18gp8wx"),_(h,"active",a[0]==="/classes"),i(C,"class","item svelte-18gp8wx"),_(C,"active",a[0]==="/racas"),i(l,"class","item svelte-18gp8wx"),_(l,"active",a[0]==="/magias"),i(c,"class","item svelte-18gp8wx"),_(c,"active",a[0]==="/tradegoods"),i(d,"class","content svelte-18gp8wx"),i(e,"class","page svelte-18gp8wx")},m(S,N){P(S,e,N),U(o,e,null),g(e,r),U(s,e,null),g(e,n),g(e,d),g(d,v),U(u,v,null),g(d,f),g(d,h),U(A,h,null),g(d,D),g(d,C),U(b,C,null),g(d,z),g(d,l),U(E,l,null),g(d,m),g(d,c),U(p,c,null),j=!0},p(S,[N]){const $={};N&17&&($.$$scope={dirty:N,ctx:S}),o.$set($);const y={};!t&&N&1&&(t=!0,y.value=S[0],Ga(()=>t=!1)),s.$set(y),(!j||N&1)&&_(v,"active",S[0]==="/iniciativa"),(!j||N&1)&&_(h,"active",S[0]==="/classes"),(!j||N&1)&&_(C,"active",S[0]==="/racas"),(!j||N&1)&&_(l,"active",S[0]==="/magias"),(!j||N&1)&&_(c,"active",S[0]==="/tradegoods")},i(S){j||(O(o.$$.fragment,S),O(s.$$.fragment,S),O(u.$$.fragment,S),O(A.$$.fragment,S),O(b.$$.fragment,S),O(E.$$.fragment,S),O(p.$$.fragment,S),j=!0)},o(S){J(o.$$.fragment,S),J(s.$$.fragment,S),J(u.$$.fragment,S),J(A.$$.fragment,S),J(b.$$.fragment,S),J(E.$$.fragment,S),J(p.$$.fragment,S),j=!1},d(S){S&&x(e),F(o),F(s),F(u),F(A),F(b),F(E),F(p)}}}function we(a,e,o){let r="/iniciativa";const s=[{slug:"/iniciativa",label:"Iniciativa"},{slug:"/classes",label:"Classes"},{slug:"/racas",label:"Raças"},{slug:"/magias",label:"Magias"},{slug:"/tradegoods",label:"Comércio"}],t=d=>d.slug===r;function n(d){r=d,o(0,r)}return[r,s,t,n]}class He extends G{constructor(e){super(),B(this,e,we,$e,Q,{})}}function We(a){let e,o,r;return o=new He({}),{c(){e=q("main"),I(o.$$.fragment)},m(s,t){P(s,e,t),U(o,e,null),r=!0},p:T,i(s){r||(O(o.$$.fragment,s),r=!0)},o(s){J(o.$$.fragment,s),r=!1},d(s){s&&x(e),F(o)}}}class Ke extends G{constructor(e){super(),B(this,e,null,We,Q,{})}}new Ke({target:document.getElementById("app")});
